...
type ScenePlayOwnerInviteNotify struct {
	...
	IsRemainReward bool   `protobuf:"varint,13,opt,name=is_remain_reward,json=isRemainReward,proto3" json:"is_remain_reward,omitempty"`
	InviteCd       uint32 `protobuf:"varint,15,opt,name=invite_cd,json=inviteCd,proto3" json:"invite_cd,omitempty"`
}
...
var file_ScenePlayOwnerInviteNotify_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x6d, 0x61, 0x69, 0x6e, 0x5f, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x18, 0x0d, 0x20,
	...
	0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x69, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x43, 0x64,
