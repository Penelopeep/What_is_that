...
type ForgeQueueData struct {
	...
	LFKLAHBIMHG uint32 `protobuf:"varint,5,opt,name=LFKLAHBIMHG,proto3" json:"LFKLAHBIMHG,omitempty"`
	ANEHHKAEKNL uint32 `protobuf:"varint,12,opt,name=ANEHHKAEKNL,proto3" json:"ANEHHKAEKNL,omitempty"`
	AvatarId    uint32 `protobuf:"varint,13,opt,name=avatar_id,json=avatarId,proto3" json:"avatar_id,omitempty"`
	ForgeId     uint32 `protobuf:"varint,14,opt,name=forge_id,json=forgeId,proto3" json:"forge_id,omitempty"`
	HANICBEMMJM uint32 `protobuf:"varint,11,opt,name=HANICBEMMJM,proto3" json:"HANICBEMMJM,omitempty"`
	EBFDNIFEKBN uint32 `protobuf:"varint,1,opt,name=EBFDNIFEKBN,proto3" json:"EBFDNIFEKBN,omitempty"`
	JHCELCAALGH uint32 `protobuf:"varint,15,opt,name=JHCELCAALGH,proto3" json:"JHCELCAALGH,omitempty"`
}
...
func (x *ForgeQueueData) GetLFKLAHBIMHG() uint32 {
	if x != nil {
		return x.LFKLAHBIMHG
	}
	return 0
}

func (x *ForgeQueueData) GetANEHHKAEKNL() uint32 {
	if x != nil {
		return x.ANEHHKAEKNL
	}
	return 0
}
...
func (x *ForgeQueueData) GetHANICBEMMJM() uint32 {
	if x != nil {
		return x.HANICBEMMJM
	}
	return 0
}

func (x *ForgeQueueData) GetEBFDNIFEKBN() uint32 {
	if x != nil {
		return x.EBFDNIFEKBN
	}
	return 0
}

func (x *ForgeQueueData) GetJHCELCAALGH() uint32 {
	if x != nil {
		return x.JHCELCAALGH
	}
	return 0
}
...
var file_ForgeQueueData_proto_rawDesc = []byte{
	...
	0x51, 0x75, 0x65, 0x75, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x46, 0x4b,
	0x4c, 0x41, 0x48, 0x42, 0x49, 0x4d, 0x48, 0x47, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b,
	0x4c, 0x46, 0x4b, 0x4c, 0x41, 0x48, 0x42, 0x49, 0x4d, 0x48, 0x47, 0x12, 0x20, 0x0a, 0x0b, 0x41,
	0x4e, 0x45, 0x48, 0x48, 0x4b, 0x41, 0x45, 0x4b, 0x4e, 0x4c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x0b, 0x41, 0x4e, 0x45, 0x48, 0x48, 0x4b, 0x41, 0x45, 0x4b, 0x4e, 0x4c, 0x12, 0x1b, 0x0a,
	...
	,
