...
type CustomDungeonAbstract struct {
	...
	BrickStatisticsMap map[uint32]uint32 `protobuf:"bytes,11,rep,name=brick_statistics_map,json=brickStatisticsMap,proto3" json:"brick_statistics_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	FLGEIJDLABF        uint32            `protobuf:"varint,15,opt,name=FLGEIJDLABF,proto3" json:"FLGEIJDLABF,omitempty"`
	JEJBBAIBLGF        uint32            `protobuf:"varint,2,opt,name=JEJBBAIBLGF,proto3" json:"JEJBBAIBLGF,omitempty"`
	FGHPHCDOPFF        uint32            `protobuf:"varint,10,opt,name=FGHPHCDOPFF,proto3" json:"FGHPHCDOPFF,omitempty"`
	GFLOKGOCOKM        uint32            `protobuf:"varint,13,opt,name=GFLOKGOCOKM,proto3" json:"GFLOKGOCOKM,omitempty"`
}
...
func (x *CustomDungeonAbstract) GetFLGEIJDLABF() uint32 {
	if x != nil {
		return x.FLGEIJDLABF
	}
	return 0
}

func (x *CustomDungeonAbstract) GetJEJBBAIBLGF() uint32 {
	if x != nil {
		return x.JEJBBAIBLGF
	}
	return 0
}

func (x *CustomDungeonAbstract) GetFGHPHCDOPFF() uint32 {
	if x != nil {
		return x.FGHPHCDOPFF
	}
	return 0
}

func (x *CustomDungeonAbstract) GetGFLOKGOCOKM() uint32 {
	if x != nil {
		return x.GFLOKGOCOKM
	}
	return 0
}
...
var file_CustomDungeonAbstract_proto_rawDesc = []byte{
	...
	0x62, 0x73, 0x74, 0x72, 0x61, 0x63, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc8, 0x02,
	...
	0x0b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x44, 0x75,
	...
	,
