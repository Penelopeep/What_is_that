...
type GCGHeartBeatNotify struct {
	...
	ServerSeq uint32 `protobuf:"varint,14,opt,name=server_seq,json=serverSeq,proto3" json:"server_seq,omitempty"`
}
...
var file_GCGHeartBeatNotify_proto_rawDesc = []byte{
	...
	0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x71, 0x18, 0x0e,
