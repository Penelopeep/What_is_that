...
type BlossomChestCreateNotify struct {
	...
	RefreshId    uint32 `protobuf:"varint,15,opt,name=refresh_id,json=refreshId,proto3" json:"refresh_id,omitempty"`
...
var file_BlossomChestCreateNotify_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x69, 0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d,
