...
type GCGMsgPhaseChange struct {
	...
	GPGCGGBIMPI        GCGPhaseType  `protobuf:"varint,3,opt,name=GPGCGGBIMPI,proto3,enum=GCGPhaseType" json:"GPGCGGBIMPI,omitempty"`
	FLEPBKJCEIE        GCGPhaseType  `protobuf:"varint,15,opt,name=FLEPBKJCEIE,proto3,enum=GCGPhaseType" json:"FLEPBKJCEIE,omitempty"`
}
...
func (x *GCGMsgPhaseChange) GetGPGCGGBIMPI() GCGPhaseType {
	if x != nil {
		return x.GPGCGGBIMPI
	}
	return GCGPhaseType_GCG_PHASE_INVALID
}

func (x *GCGMsgPhaseChange) GetFLEPBKJCEIE() GCGPhaseType {
	if x != nil {
		return x.FLEPBKJCEIE
	}
	return GCGPhaseType_GCG_PHASE_INVALID
}
...
var file_GCGMsgPhaseChange_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x05, 0x20,
	...
	0x72, 0x4d, 0x61, 0x70, 0x12, 0x2f, 0x0a, 0x0b, 0x47, 0x50, 0x47, 0x43, 0x47, 0x47, 0x42, 0x49,
	0x4d, 0x50, 0x49, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x47, 0x43, 0x47, 0x50,
	0x68, 0x61, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x47, 0x50, 0x47, 0x43, 0x47, 0x47,
	0x42, 0x49, 0x4d, 0x50, 0x49, 0x12, 0x2f, 0x0a, 0x0b, 0x46, 0x4c, 0x45, 0x50, 0x42, 0x4b, 0x4a,
	0x43, 0x45, 0x49, 0x45, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x47, 0x43, 0x47,
	0x50, 0x68, 0x61, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0b, 0x46, 0x4c, 0x45, 0x50, 0x42,
	0x4b, 0x4a, 0x43, 0x45, 0x49, 0x45, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06,
...
var file_GCGMsgPhaseChange_proto_depIdxs = []int32{
	...
	2, // 1: GCGMsgPhaseChange.GPGCGGBIMPI:type_name -> GCGPhaseType
	2, // 2: GCGMsgPhaseChange.FLEPBKJCEIE:type_name -> GCGPhaseType
