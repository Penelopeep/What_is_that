...
type WindFieldDetailInfo struct {
	...
	StageInfoList []*WindFieldStageInfo `protobuf:"bytes,3,rep,name=stage_info_list,json=stageInfoList,proto3" json:"stage_info_list,omitempty"`
}
...
var file_WindFieldDetailInfo_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x57, 0x69, 0x6e, 0x64, 0x46, 0x69, 0x65, 0x6c,
