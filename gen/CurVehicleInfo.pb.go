...
type CurVehicleInfo struct {
	...
	DNJIMMEONNI *Vector `protobuf:"bytes,4,opt,name=DNJIMMEONNI,proto3" json:"DNJIMMEONNI,omitempty"`
	PDEPBDNGIAB uint32  `protobuf:"varint,5,opt,name=PDEPBDNGIAB,proto3" json:"PDEPBDNGIAB,omitempty"`
	MAKPDIBNPAP *Vector `protobuf:"bytes,6,opt,name=MAKPDIBNPAP,proto3" json:"MAKPDIBNPAP,omitempty"`
}
...
func (x *CurVehicleInfo) GetDNJIMMEONNI() *Vector {
	if x != nil {
...
func (x *CurVehicleInfo) GetPDEPBDNGIAB() uint32 {
	if x != nil {
...
func (x *CurVehicleInfo) GetMAKPDIBNPAP() *Vector {
	if x != nil {
...
var file_CurVehicleInfo_proto_rawDesc = []byte{
	...
	,
...
var file_CurVehicleInfo_proto_depIdxs = []int32{
	1, // 0: CurVehicleInfo.DNJIMMEONNI:type_name -> Vector
	1, // 1: CurVehicleInfo.MAKPDIBNPAP:type_name -> Vector
