...
type PlantFlowerGiveFriendFlowerRsp struct {
	...
	LimitFlowerList []uint32 `protobuf:"varint,3,rep,packed,name=limit_flower_list,json=limitFlowerList,proto3" json:"limit_flower_list,omitempty"`
}
...
var file_PlantFlowerGiveFriendFlowerRsp_proto_rawDesc = []byte{
	...
	0x6f, 0x77, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52,
