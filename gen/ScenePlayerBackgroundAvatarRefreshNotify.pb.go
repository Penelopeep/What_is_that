...
type ScenePlayerBackgroundAvatarRefreshNotify struct {
	...
	AppearType VisionType         `protobuf:"varint,8,opt,name=appear_type,json=appearType,proto3,enum=VisionType" json:"appear_type,omitempty"`
	EntityList []*SceneEntityInfo `protobuf:"bytes,14,rep,name=entity_list,json=entityList,proto3" json:"entity_list,omitempty"`
}
...
var file_ScenePlayerBackgroundAvatarRefreshNotify_proto_rawDesc = []byte{
	...
	0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x2c, 0x0a, 0x0b,
	...
	0x74, 0x69, 0x74, 0x79, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32,
