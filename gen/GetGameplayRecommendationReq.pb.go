...
type GetGameplayRecommendationReq_SkillRequest struct {
	SkillRequest *GameplayRecommendationSkillRequest `protobuf:"bytes,1417,opt,name=skill_request,json=skillRequest,proto3,oneof"`
}

type GetGameplayRecommendationReq_ReliquaryRequest struct {
	ReliquaryRequest *GameplayRecommendationReliquaryRequest `protobuf:"bytes,616,opt,name=reliquary_request,json=reliquaryRequest,proto3,oneof"`
}

type GetGameplayRecommendationReq_ElementReliquaryRequest struct {
	ElementReliquaryRequest *GameplayRecommendationElementReliquaryRequest `protobuf:"bytes,2013,opt,name=element_reliquary_request,json=elementReliquaryRequest,proto3,oneof"`
}
...
var file_GetGameplayRecommendationReq_proto_rawDesc = []byte{
	...
	0x18, 0x89, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x70, 0x6c,
	...
	0x74, 0x18, 0xe8, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x47, 0x61, 0x6d, 0x65, 0x70,
	0x6c, 0x61, 0x79, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x6c, 0x69, 0x71, 0x75, 0x61, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x73, 0x74, 0x18, 0xdd, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x47, 0x61, 0x6d, 0x65,
