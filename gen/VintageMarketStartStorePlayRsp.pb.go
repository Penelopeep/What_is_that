...
type VintageMarketStartStorePlayRsp struct {
	...
	HCINPOEALAH uint32 `protobuf:"varint,10,opt,name=HCINPOEALAH,proto3" json:"HCINPOEALAH,omitempty"`
	BPKMLMJPAMG uint32 `protobuf:"varint,2,opt,name=BPKMLMJPAMG,proto3" json:"BPKMLMJPAMG,omitempty"`
}
...
func (x *VintageMarketStartStorePlayRsp) GetHCINPOEALAH() uint32 {
	if x != nil {
		return x.HCINPOEALAH
	}
	return 0
}

func (x *VintageMarketStartStorePlayRsp) GetBPKMLMJPAMG() uint32 {
	if x != nil {
		return x.BPKMLMJPAMG
	}
	return 0
}
...
var file_VintageMarketStartStorePlayRsp_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x52,
	0x6f, 0x75, 0x6e, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x48, 0x43, 0x49, 0x4e, 0x50, 0x4f, 0x45, 0x41,
	0x4c, 0x41, 0x48, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x48, 0x43, 0x49, 0x4e, 0x50,
	0x4f, 0x45, 0x41, 0x4c, 0x41, 0x48, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x50, 0x4b, 0x4d, 0x4c, 0x4d,
	0x4a, 0x50, 0x41, 0x4d, 0x47, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x50, 0x4b,
	0x4d, 0x4c, 0x4d, 0x4a, 0x50, 0x41, 0x4d, 0x47, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f,
