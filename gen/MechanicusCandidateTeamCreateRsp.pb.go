...
type MechanicusCandidateTeamCreateRsp struct {
	...
	DifficultLevel uint32 `protobuf:"varint,1,opt,name=difficult_level,json=difficultLevel,proto3" json:"difficult_level,omitempty"`
}
...
var file_MechanicusCandidateTeamCreateRsp_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63,
