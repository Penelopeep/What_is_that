...
type PersonalSceneJumpRsp struct {
	...
	DestSceneId uint32  `protobuf:"varint,13,opt,name=dest_scene_id,json=destSceneId,proto3" json:"dest_scene_id,omitempty"`
	DestPos     *Vector `protobuf:"bytes,4,opt,name=dest_pos,json=destPos,proto3" json:"dest_pos,omitempty"`
...
var file_PersonalSceneJumpRsp_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x64, 0x65, 0x73, 0x74, 0x53,
