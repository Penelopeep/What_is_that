...
type EnterRogueDiaryDungeonReq struct {
	...
	ChosenAvatarList []*RogueDiaryAvatar `protobuf:"bytes,6,rep,name=chosen_avatar_list,json=chosenAvatarList,proto3" json:"chosen_avatar_list,omitempty"`
	ChosenCardList   []uint32            `protobuf:"varint,2,rep,packed,name=chosen_card_list,json=chosenCardList,proto3" json:"chosen_card_list,omitempty"`
}
...
var file_EnterRogueDiaryDungeonReq_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x5f, 0x63, 0x61, 0x72, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03,
