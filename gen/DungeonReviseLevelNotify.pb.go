...
type DungeonReviseLevelNotify struct {
	...
	HFGFELKHDDK uint32 `protobuf:"varint,4,opt,name=HFGFELKHDDK,proto3" json:"HFGFELKHDDK,omitempty"`
	JHNHKIBHLBA uint32 `protobuf:"varint,12,opt,name=JHNHKIBHLBA,proto3" json:"JHNHKIBHLBA,omitempty"`
...
func (x *DungeonReviseLevelNotify) GetHFGFELKHDDK() uint32 {
	if x != nil {
		return x.HFGFELKHDDK
	}
	return 0
}

func (x *DungeonReviseLevelNotify) GetJHNHKIBHLBA() uint32 {
	if x != nil {
		return x.JHNHKIBHLBA
	}
	return 0
}
...
var file_DungeonReviseLevelNotify_proto_rawDesc = []byte{
	...
	0x48, 0x46, 0x47, 0x46, 0x45, 0x4c, 0x4b, 0x48, 0x44, 0x44, 0x4b, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x48, 0x46, 0x47, 0x46, 0x45, 0x4c, 0x4b, 0x48, 0x44, 0x44, 0x4b, 0x12, 0x20,
	0x0a, 0x0b, 0x4a, 0x48, 0x4e, 0x48, 0x4b, 0x49, 0x42, 0x48, 0x4c, 0x42, 0x41, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x48, 0x4e, 0x48, 0x4b, 0x49, 0x42, 0x48, 0x4c, 0x42, 0x41,
