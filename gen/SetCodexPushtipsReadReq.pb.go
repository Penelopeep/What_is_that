...
type SetCodexPushtipsReadReq struct {
	...
	NACFJFLGNFH uint32 `protobuf:"varint,8,opt,name=NACFJFLGNFH,proto3" json:"NACFJFLGNFH,omitempty"`
	AOLDDCCIAHH uint32 `protobuf:"varint,15,opt,name=AOLDDCCIAHH,proto3" json:"AOLDDCCIAHH,omitempty"`
}
...
func (x *SetCodexPushtipsReadReq) GetNACFJFLGNFH() uint32 {
	if x != nil {
		return x.NACFJFLGNFH
	}
	return 0
}

func (x *SetCodexPushtipsReadReq) GetAOLDDCCIAHH() uint32 {
	if x != nil {
		return x.AOLDDCCIAHH
	}
	return 0
}
...
var file_SetCodexPushtipsReadReq_proto_rawDesc = []byte{
	...
	0x69, 0x70, 0x73, 0x52, 0x65, 0x61, 0x64, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x4e, 0x41,
	0x43, 0x46, 0x4a, 0x46, 0x4c, 0x47, 0x4e, 0x46, 0x48, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x4e, 0x41, 0x43, 0x46, 0x4a, 0x46, 0x4c, 0x47, 0x4e, 0x46, 0x48, 0x12, 0x20, 0x0a, 0x0b,
	0x41, 0x4f, 0x4c, 0x44, 0x44, 0x43, 0x43, 0x49, 0x41, 0x48, 0x48, 0x18, 0x0f, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x41, 0x4f, 0x4c, 0x44, 0x44, 0x43, 0x43, 0x49, 0x41, 0x48, 0x48, 0x42, 0x06,
