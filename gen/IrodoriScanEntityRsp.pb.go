...
type IrodoriScanEntityRsp struct {
	...
	IsGetInspiration bool                    `protobuf:"varint,3,opt,name=is_get_inspiration,json=isGetInspiration,proto3" json:"is_get_inspiration,omitempty"`
	Retcode          int32                   `protobuf:"varint,5,opt,name=retcode,proto3" json:"retcode,omitempty"`
	ThemeData        *IrodoriPoetryThemeData `protobuf:"bytes,12,opt,name=theme_data,json=themeData,proto3" json:"theme_data,omitempty"`
}
...
var file_IrodoriScanEntityRsp_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x69, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52,
	...
	0x68, 0x65, 0x6d, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x61, 0x74, 0x61, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
