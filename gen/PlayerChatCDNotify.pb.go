...
type PlayerChatCDNotify struct {
	...
	OverTime uint32 `protobuf:"varint,3,opt,name=over_time,json=overTime,proto3" json:"over_time,omitempty"`
}
...
var file_PlayerChatCDNotify_proto_rawDesc = []byte{
	...
	0x12, 0x1b, 0x0a, 0x09, 0x6f, 0x76, 0x65, 0x72, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20,
