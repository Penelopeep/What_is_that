...
type EvtCreateGadgetNotify struct {
	...
	InitEulerAngles          *Vector     `protobuf:"bytes,3,opt,name=init_euler_angles,json=initEulerAngles,proto3" json:"init_euler_angles,omitempty"`
	DKJHPANLPGJ              bool        `protobuf:"varint,1474,opt,name=DKJHPANLPGJ,proto3" json:"DKJHPANLPGJ,omitempty"`
	IsPeerIdFromPlayer       bool        `protobuf:"varint,2005,opt,name=is_peer_id_from_player,json=isPeerIdFromPlayer,proto3" json:"is_peer_id_from_player,omitempty"`
	TargetLockPointIndex     uint32      `protobuf:"varint,12,opt,name=target_lock_point_index,json=targetLockPointIndex,proto3" json:"target_lock_point_index,omitempty"`
	TargetLockPointIndexList []uint32    `protobuf:"varint,1490,rep,packed,name=target_lock_point_index_list,json=targetLockPointIndexList,proto3" json:"target_lock_point_index_list,omitempty"`
	InitPos                  *Vector     `protobuf:"bytes,1,opt,name=init_pos,json=initPos,proto3" json:"init_pos,omitempty"`
	DGIFLLEHOND              bool        `protobuf:"varint,6,opt,name=DGIFLLEHOND,proto3" json:"DGIFLLEHOND,omitempty"`
	CampType                 uint32      `protobuf:"varint,8,opt,name=camp_type,json=campType,proto3" json:"camp_type,omitempty"`
	CampId                   uint32      `protobuf:"varint,14,opt,name=camp_id,json=campId,proto3" json:"camp_id,omitempty"`
	TargetEntityIdList       []uint32    `protobuf:"varint,383,rep,packed,name=target_entity_id_list,json=targetEntityIdList,proto3" json:"target_entity_id_list,omitempty"`
	...
	IJDOMBBFNOM              bool        `protobuf:"varint,7,opt,name=IJDOMBBFNOM,proto3" json:"IJDOMBBFNOM,omitempty"`
	...
	PropOwnerEntityId        uint32      `protobuf:"varint,4,opt,name=prop_owner_entity_id,json=propOwnerEntityId,proto3" json:"prop_owner_entity_id,omitempty"`
}
...
func (x *EvtCreateGadgetNotify) GetDKJHPANLPGJ() bool {
	if x != nil {
		return x.DKJHPANLPGJ
	}
	return false
}
...
func (x *EvtCreateGadgetNotify) GetDGIFLLEHOND() bool {
	if x != nil {
		return x.DGIFLLEHOND
	}
	return false
}
...
func (x *EvtCreateGadgetNotify) GetIJDOMBBFNOM() bool {
	if x != nil {
		return x.IJDOMBBFNOM
	}
	return false
}
...
var file_EvtCreateGadgetNotify_proto_rawDesc = []byte{
	...
	0x1a, 0x0c, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x89,
	0x06, 0x0a, 0x15, 0x45, 0x76, 0x74, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x47, 0x61, 0x64, 0x67,
	0x65, 0x74, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x26, 0x0a, 0x0f, 0x6f, 0x77, 0x6e, 0x65,
	...
	,
