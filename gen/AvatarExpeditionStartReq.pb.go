...
type AvatarExpeditionStartReq struct {
	...
	ExpId      uint32 `protobuf:"varint,7,opt,name=exp_id,json=expId,proto3" json:"exp_id,omitempty"`
...
var file_AvatarExpeditionStartReq_proto_rawDesc = []byte{
	...
	0x65, 0x78, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x65, 0x78,
