...
type GCGSkillPreviewReactionInfo struct {
	...
	EIJFJJJBIIH uint32 `protobuf:"varint,9,opt,name=EIJFJJJBIIH,proto3" json:"EIJFJJJBIIH,omitempty"`
	LKDBPBBGDBN uint32 `protobuf:"varint,12,opt,name=LKDBPBBGDBN,proto3" json:"LKDBPBBGDBN,omitempty"`
}
...
func (x *GCGSkillPreviewReactionInfo) GetEIJFJJJBIIH() uint32 {
	if x != nil {
		return x.EIJFJJJBIIH
	}
	return 0
}

func (x *GCGSkillPreviewReactionInfo) GetLKDBPBBGDBN() uint32 {
	if x != nil {
		return x.LKDBPBBGDBN
	}
	return 0
}
...
var file_GCGSkillPreviewReactionInfo_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x45, 0x49, 0x4a, 0x46, 0x4a, 0x4a, 0x4a, 0x42, 0x49, 0x49,
	0x48, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x45, 0x49, 0x4a, 0x46, 0x4a, 0x4a, 0x4a,
	0x42, 0x49, 0x49, 0x48, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x4b, 0x44, 0x42, 0x50, 0x42, 0x42, 0x47,
	0x44, 0x42, 0x4e, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4c, 0x4b, 0x44, 0x42, 0x50,
	0x42, 0x42, 0x47, 0x44, 0x42, 0x4e, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06,
