...
type GalleryPreStartNotify struct {
	...
	PreStartEndTime uint32 `protobuf:"varint,6,opt,name=pre_start_end_time,json=preStartEndTime,proto3" json:"pre_start_end_time,omitempty"`
}
...
var file_GalleryPreStartNotify_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x5f, 0x65, 0x6e, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28,
