...
type ForceDragAvatarNotify struct {
	...
	IsFirstValid bool        `protobuf:"varint,4,opt,name=is_first_valid,json=isFirstValid,proto3" json:"is_first_valid,omitempty"`
	HBPMGOHDIOO  uint64      `protobuf:"varint,8,opt,name=HBPMGOHDIOO,proto3" json:"HBPMGOHDIOO,omitempty"`
	...
	HEDKENGIAPE  uint64      `protobuf:"varint,5,opt,name=HEDKENGIAPE,proto3" json:"HEDKENGIAPE,omitempty"`
}
...
func (x *ForceDragAvatarNotify) GetHBPMGOHDIOO() uint64 {
	if x != nil {
		return x.HBPMGOHDIOO
	}
	return 0
}
...
func (x *ForceDragAvatarNotify) GetHEDKENGIAPE() uint64 {
	if x != nil {
		return x.HEDKENGIAPE
	}
	return 0
}
...
var file_ForceDragAvatarNotify_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x73,
	0x63, 0x65, 0x6e, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x24, 0x0a, 0x0e, 0x69, 0x73, 0x5f, 0x66,
	0x69, 0x72, 0x73, 0x74, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0c, 0x69, 0x73, 0x46, 0x69, 0x72, 0x73, 0x74, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x12, 0x20,
	0x0a, 0x0b, 0x48, 0x42, 0x50, 0x4d, 0x47, 0x4f, 0x48, 0x44, 0x49, 0x4f, 0x4f, 0x18, 0x08, 0x20,
	0x01, 0x28, 0x04, 0x52, 0x0b, 0x48, 0x42, 0x50, 0x4d, 0x47, 0x4f, 0x48, 0x44, 0x49, 0x4f, 0x4f,
	...
	0x0a, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x48,
	0x45, 0x44, 0x4b, 0x45, 0x4e, 0x47, 0x49, 0x41, 0x50, 0x45, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04,
	0x52, 0x0b, 0x48, 0x45, 0x44, 0x4b, 0x45, 0x4e, 0x47, 0x49, 0x41, 0x50, 0x45, 0x42, 0x06, 0x5a,
