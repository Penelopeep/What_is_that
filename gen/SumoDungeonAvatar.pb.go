...
type SumoDungeonAvatar struct {
	...
	IsAvlive   bool   `protobuf:"varint,12,opt,name=is_avlive,json=isAvlive,proto3" json:"is_avlive,omitempty"`
	AvatarGuid uint64 `protobuf:"varint,2,opt,name=avatar_guid,json=avatarGuid,proto3" json:"avatar_guid,omitempty"`
	IsTrial    bool   `protobuf:"varint,14,opt,name=is_trial,json=isTrial,proto3" json:"is_trial,omitempty"`
}
...
var file_SumoDungeonAvatar_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x69, 0x73, 0x5f, 0x61, 0x76, 0x6c, 0x69, 0x76, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28,
	...
	0x69, 0x73, 0x5f, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07,
	0x69, 0x73, 0x54, 0x72, 0x69, 0x61, 0x6c, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62,
