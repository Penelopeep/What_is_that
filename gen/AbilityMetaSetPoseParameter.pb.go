...
type AbilityMetaSetPoseParameter struct {
	...
	Value *AnimatorParameterValueInfoPair `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
}
...
var file_AbilityMetaSetPoseParameter_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x41, 0x6e, 0x69, 0x6d, 0x61, 0x74,
