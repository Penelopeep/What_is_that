...
type FleurFairFallSettleNotify struct {
	...
	SettleInfoMap map[uint32]*FleurFairFallSettleInfo `protobuf:"bytes,14,rep,name=settle_info_map,json=settleInfoMap,proto3" json:"settle_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_FleurFairFallSettleNotify_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x46, 0x6c, 0x65, 0x75, 0x72,
