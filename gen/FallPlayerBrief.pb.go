...
type FallPlayerBrief struct {
	...
	IsGround bool   `protobuf:"varint,3,opt,name=is_ground,json=isGround,proto3" json:"is_ground,omitempty"`
}
...
var file_FallPlayerBrief_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x47, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x42,
