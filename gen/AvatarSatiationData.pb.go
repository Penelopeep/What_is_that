...
type AvatarSatiationData struct {
	...
	FinishTime        float32 `protobuf:"fixed32,12,opt,name=finish_time,json=finishTime,proto3" json:"finish_time,omitempty"`
	PenaltyFinishTime float32 `protobuf:"fixed32,8,opt,name=penalty_finish_time,json=penaltyFinishTime,proto3" json:"penalty_finish_time,omitempty"`
...
var file_AvatarSatiationData_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0a, 0x66, 0x69, 0x6e, 0x69, 0x73, 0x68,
