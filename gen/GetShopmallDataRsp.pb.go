...
type GetShopmallDataRsp struct {
	...
	ShopTypeList []uint32 `protobuf:"varint,9,rep,packed,name=shop_type_list,json=shopTypeList,proto3" json:"shop_type_list,omitempty"`
...
var file_GetShopmallDataRsp_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0c, 0x73, 0x68, 0x6f, 0x70, 0x54, 0x79,
