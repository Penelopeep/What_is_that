...
type ModifierDurability struct {
	...
	HGJMHAFDFOC float32 `protobuf:"fixed32,1,opt,name=HGJMHAFDFOC,proto3" json:"HGJMHAFDFOC,omitempty"`
	AFFIDFJHCFM float32 `protobuf:"fixed32,2,opt,name=AFFIDFJHCFM,proto3" json:"AFFIDFJHCFM,omitempty"`
}
...
func (x *ModifierDurability) GetHGJMHAFDFOC() float32 {
	if x != nil {
		return x.HGJMHAFDFOC
	}
	return 0
}

func (x *ModifierDurability) GetAFFIDFJHCFM() float32 {
	if x != nil {
		return x.AFFIDFJHCFM
	}
	return 0
}
...
var file_ModifierDurability_proto_rawDesc = []byte{
	...
	0x6c, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x58, 0x0a, 0x12, 0x4d, 0x6f,
	0x64, 0x69, 0x66, 0x69, 0x65, 0x72, 0x44, 0x75, 0x72, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	0x12, 0x20, 0x0a, 0x0b, 0x48, 0x47, 0x4a, 0x4d, 0x48, 0x41, 0x46, 0x44, 0x46, 0x4f, 0x43, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x48, 0x47, 0x4a, 0x4d, 0x48, 0x41, 0x46, 0x44, 0x46,
	0x4f, 0x43, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x46, 0x46, 0x49, 0x44, 0x46, 0x4a, 0x48, 0x43, 0x46,
	0x4d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x41, 0x46, 0x46, 0x49, 0x44, 0x46, 0x4a,
	0x48, 0x43, 0x46, 0x4d, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
