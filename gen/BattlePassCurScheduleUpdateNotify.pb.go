...
type BattlePassCurScheduleUpdateNotify struct {
	...
	CurSchedule     *BattlePassSchedule `protobuf:"bytes,7,opt,name=cur_schedule,json=curSchedule,proto3" json:"cur_schedule,omitempty"`
	HaveCurSchedule bool                `protobuf:"varint,6,opt,name=have_cur_schedule,json=haveCurSchedule,proto3" json:"have_cur_schedule,omitempty"`
}
...
var file_BattlePassCurScheduleUpdateNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x68, 0x61,
