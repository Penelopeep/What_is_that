...
type GetAuthSalesmanInfoRsp struct {
	...
	DayRewardId uint32 `protobuf:"varint,4,opt,name=day_reward_id,json=dayRewardId,proto3" json:"day_reward_id,omitempty"`
...
var file_GetAuthSalesmanInfoRsp_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
