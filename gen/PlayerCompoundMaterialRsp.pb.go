...
type PlayerCompoundMaterialRsp struct {
	...
	CompoundQueData *CompoundQueueData `protobuf:"bytes,4,opt,name=compound_que_data,json=compoundQueData,proto3" json:"compound_que_data,omitempty"`
...
var file_PlayerCompoundMaterialRsp_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x64, 0x5f, 0x71, 0x75, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x04, 0x20, 0x01,
