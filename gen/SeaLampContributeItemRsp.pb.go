...
type SeaLampContributeItemRsp struct {
	...
	AddProgress uint32 `protobuf:"varint,14,opt,name=add_progress,json=addProgress,proto3" json:"add_progress,omitempty"`
	Retcode     int32  `protobuf:"varint,2,opt,name=retcode,proto3" json:"retcode,omitempty"`
	LHEFDGPEFPN uint32 `protobuf:"varint,4,opt,name=LHEFDGPEFPN,proto3" json:"LHEFDGPEFPN,omitempty"`
	LCMDALFODMC uint32 `protobuf:"varint,7,opt,name=LCMDALFODMC,proto3" json:"LCMDALFODMC,omitempty"`
}
...
func (x *SeaLampContributeItemRsp) GetLHEFDGPEFPN() uint32 {
	if x != nil {
		return x.LHEFDGPEFPN
	}
	return 0
}

func (x *SeaLampContributeItemRsp) GetLCMDALFODMC() uint32 {
	if x != nil {
		return x.LCMDALFODMC
	}
	return 0
}
...
var file_SeaLampContributeItemRsp_proto_rawDesc = []byte{
	...
	0x0c, 0x61, 0x64, 0x64, 0x5f, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x18, 0x0e, 0x20,
	...
	0x05, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x48,
	0x45, 0x46, 0x44, 0x47, 0x50, 0x45, 0x46, 0x50, 0x4e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x4c, 0x48, 0x45, 0x46, 0x44, 0x47, 0x50, 0x45, 0x46, 0x50, 0x4e, 0x12, 0x20, 0x0a, 0x0b,
	0x4c, 0x43, 0x4d, 0x44, 0x41, 0x4c, 0x46, 0x4f, 0x44, 0x4d, 0x43, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x4c, 0x43, 0x4d, 0x44, 0x41, 0x4c, 0x46, 0x4f, 0x44, 0x4d, 0x43, 0x42, 0x06,
