...
type VintageHuntingFirstStageInfo struct {
	...
	BKPLONJEOAF uint32 `protobuf:"varint,12,opt,name=BKPLONJEOAF,proto3" json:"BKPLONJEOAF,omitempty"`
	AAFNJPABDDJ uint32 `protobuf:"varint,13,opt,name=AAFNJPABDDJ,proto3" json:"AAFNJPABDDJ,omitempty"`
	Score       uint32 `protobuf:"varint,15,opt,name=score,proto3" json:"score,omitempty"`
	CALCAHMEJGN uint32 `protobuf:"varint,1,opt,name=CALCAHMEJGN,proto3" json:"CALCAHMEJGN,omitempty"`
}
...
func (x *VintageHuntingFirstStageInfo) GetBKPLONJEOAF() uint32 {
	if x != nil {
		return x.BKPLONJEOAF
	}
	return 0
}

func (x *VintageHuntingFirstStageInfo) GetAAFNJPABDDJ() uint32 {
	if x != nil {
		return x.AAFNJPABDDJ
	}
	return 0
}
...
func (x *VintageHuntingFirstStageInfo) GetCALCAHMEJGN() uint32 {
	if x != nil {
		return x.CALCAHMEJGN
	}
	return 0
}
...
var file_VintageHuntingFirstStageInfo_proto_rawDesc = []byte{
	...
	,
}
