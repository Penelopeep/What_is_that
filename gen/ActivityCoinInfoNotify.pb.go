...
type ActivityCoinInfoNotify struct {
	...
	ActivityCoinMap map[uint32]uint32 `protobuf:"bytes,14,rep,name=activity_coin_map,json=activityCoinMap,proto3" json:"activity_coin_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
var file_ActivityCoinInfoNotify_proto_rawDesc = []byte{
	...
	0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79,
