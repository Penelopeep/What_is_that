...
type TakeResinCardDailyRewardReq struct {
	...
	ProductConfigId uint32 `protobuf:"varint,5,opt,name=product_config_id,json=productConfigId,proto3" json:"product_config_id,omitempty"`
}
...
var file_TakeResinCardDailyRewardReq_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0f, 0x70,
