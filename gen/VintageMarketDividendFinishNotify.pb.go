...
type VintageMarketDividendFinishNotify struct {
	...
	FCOMCAIMCGG uint32 `protobuf:"varint,3,opt,name=FCOMCAIMCGG,proto3" json:"FCOMCAIMCGG,omitempty"`
}
...
func (x *VintageMarketDividendFinishNotify) GetMFMAKKFFAHP() uint32 {
	if x != nil {
...
func (x *VintageMarketDividendFinishNotify) GetFCOMCAIMCGG() uint32 {
	if x != nil {
...
var file_VintageMarketDividendFinishNotify_proto_rawDesc = []byte{
	...
	0x12, 0x20, 0x0a, 0x0b, 0x46, 0x43, 0x4f, 0x4d, 0x43, 0x41, 0x49, 0x4d, 0x43, 0x47, 0x47, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x46, 0x43, 0x4f, 0x4d, 0x43, 0x41, 0x49, 0x4d, 0x43,
	0x47, 0x47, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
