...
type GetReunionPrivilegeInfoReq struct {
	...
	PrivilegeId uint32 `protobuf:"varint,12,opt,name=privilege_id,json=privilegeId,proto3" json:"privilege_id,omitempty"`
}
...
var file_GetReunionPrivilegeInfoReq_proto_rawDesc = []byte{
	...
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x70, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67,
