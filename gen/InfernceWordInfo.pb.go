...
type InfernceWordInfo struct {
	...
	MDPDECFIPAN    bool   `protobuf:"varint,11,opt,name=MDPDECFIPAN,proto3" json:"MDPDECFIPAN,omitempty"`
	UnlockByWordId uint32 `protobuf:"varint,1,opt,name=unlock_by_word_id,json=unlockByWordId,proto3" json:"unlock_by_word_id,omitempty"`
	WordId         uint32 `protobuf:"varint,10,opt,name=word_id,json=wordId,proto3" json:"word_id,omitempty"`
	DJFAOPBHEAL    bool   `protobuf:"varint,4,opt,name=DJFAOPBHEAL,proto3" json:"DJFAOPBHEAL,omitempty"`
	OPBALHEMOEE    bool   `protobuf:"varint,3,opt,name=OPBALHEMOEE,proto3" json:"OPBALHEMOEE,omitempty"`
}
...
func (x *InfernceWordInfo) GetMDPDECFIPAN() bool {
	if x != nil {
		return x.MDPDECFIPAN
	}
	return false
}
...
func (x *InfernceWordInfo) GetDJFAOPBHEAL() bool {
	if x != nil {
		return x.DJFAOPBHEAL
	}
	return false
}

func (x *InfernceWordInfo) GetOPBALHEMOEE() bool {
	if x != nil {
		return x.OPBALHEMOEE
	}
	return false
}
...
var file_InfernceWordInfo_proto_rawDesc = []byte{
	...
	,
