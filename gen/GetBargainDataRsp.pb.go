...
type GetBargainDataRsp struct {
	...
	BargainId uint32           `protobuf:"varint,6,opt,name=bargain_id,json=bargainId,proto3" json:"bargain_id,omitempty"`
...
var file_GetBargainDataRsp_proto_rawDesc = []byte{
	...
	0x1d, 0x0a, 0x0a, 0x62, 0x61, 0x72, 0x67, 0x61, 0x69, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20,
