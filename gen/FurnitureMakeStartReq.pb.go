...
type FurnitureMakeStartReq struct {
	...
	MakeId   uint32 `protobuf:"varint,8,opt,name=make_id,json=makeId,proto3" json:"make_id,omitempty"`
...
var file_FurnitureMakeStartReq_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6d, 0x61, 0x6b, 0x65, 0x49, 0x64, 0x12,
