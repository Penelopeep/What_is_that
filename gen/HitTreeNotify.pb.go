...
type HitTreeNotify struct {
	...
	DropPos  *Vector `protobuf:"bytes,1,opt,name=drop_pos,json=dropPos,proto3" json:"drop_pos,omitempty"`
	TreeType uint32  `protobuf:"varint,9,opt,name=tree_type,json=treeType,proto3" json:"tree_type,omitempty"`
}
...
var file_HitTreeNotify_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x65, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x08, 0x74, 0x72, 0x65, 0x65, 0x54, 0x79, 0x70, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e,
