...
type NpcTalkReq struct {
	...
	NpcEntityId uint32 `protobuf:"varint,7,opt,name=npc_entity_id,json=npcEntityId,proto3" json:"npc_entity_id,omitempty"`
	EntityId    uint32 `protobuf:"varint,14,opt,name=entity_id,json=entityId,proto3" json:"entity_id,omitempty"`
	TalkId      uint32 `protobuf:"varint,11,opt,name=talk_id,json=talkId,proto3" json:"talk_id,omitempty"`
}
...
var file_NpcTalkReq_proto_rawDesc = []byte{
	...
	0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x6e, 0x70, 0x63, 0x45, 0x6e, 0x74, 0x69,
	...
	0x64, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x61, 0x6c, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x06, 0x74, 0x61, 0x6c, 0x6b, 0x49, 0x64, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65,
