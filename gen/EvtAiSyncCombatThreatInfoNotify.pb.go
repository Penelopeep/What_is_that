...
type EvtAiSyncCombatThreatInfoNotify struct {
	...
	CombatThreatInfoMap map[uint32]*AiThreatInfo `protobuf:"bytes,5,rep,name=combat_threat_info_map,json=combatThreatInfoMap,proto3" json:"combat_threat_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
