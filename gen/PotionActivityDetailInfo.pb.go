...
type PotionActivityDetailInfo struct {
	...
	StageList []*PotionStageData `protobuf:"bytes,3,rep,name=stage_list,json=stageList,proto3" json:"stage_list,omitempty"`
}
...
var file_PotionActivityDetailInfo_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x50, 0x6f, 0x74, 0x69, 0x6f, 0x6e,
