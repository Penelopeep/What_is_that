...
type AbilityMixinShootFromCamera struct {
	...
	Forward *Vector `protobuf:"bytes,10,opt,name=forward,proto3" json:"forward,omitempty"`
	InitPos *Vector `protobuf:"bytes,3,opt,name=init_pos,json=initPos,proto3" json:"init_pos,omitempty"`
}
...
var file_AbilityMixinShootFromCamera_proto_rawDesc = []byte{
	...
	0x12, 0x21, 0x0a, 0x07, 0x66, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28,
	...
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x07, 0x2e, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x52, 0x07,
	0x69, 0x6e, 0x69, 0x74, 0x50, 0x6f, 0x73, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62,
