...
type GCGSkillPreviewTokenInfo struct {
	...
	PFPJPOEDPON uint32 `protobuf:"varint,15,opt,name=PFPJPOEDPON,proto3" json:"PFPJPOEDPON,omitempty"`
	MEKGLJAFFHC uint32 `protobuf:"varint,4,opt,name=MEKGLJAFFHC,proto3" json:"MEKGLJAFFHC,omitempty"`
	BKHAKDNDMIO uint32 `protobuf:"varint,2,opt,name=BKHAKDNDMIO,proto3" json:"BKHAKDNDMIO,omitempty"`
}
...
func (x *GCGSkillPreviewTokenInfo) GetPFPJPOEDPON() uint32 {
	if x != nil {
		return x.PFPJPOEDPON
	}
	return 0
}

func (x *GCGSkillPreviewTokenInfo) GetMEKGLJAFFHC() uint32 {
	if x != nil {
		return x.MEKGLJAFFHC
	}
	return 0
}

func (x *GCGSkillPreviewTokenInfo) GetBKHAKDNDMIO() uint32 {
	if x != nil {
...
var file_GCGSkillPreviewTokenInfo_proto_rawDesc = []byte{
	...
	0x0b, 0x50, 0x46, 0x50, 0x4a, 0x50, 0x4f, 0x45, 0x44, 0x50, 0x4f, 0x4e, 0x18, 0x0f, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x50, 0x46, 0x50, 0x4a, 0x50, 0x4f, 0x45, 0x44, 0x50, 0x4f, 0x4e, 0x12,
	0x20, 0x0a, 0x0b, 0x4d, 0x45, 0x4b, 0x47, 0x4c, 0x4a, 0x41, 0x46, 0x46, 0x48, 0x43, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4d, 0x45, 0x4b, 0x47, 0x4c, 0x4a, 0x41, 0x46, 0x46, 0x48,
	0x43, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x4b, 0x48, 0x41, 0x4b, 0x44, 0x4e, 0x44, 0x4d, 0x49, 0x4f,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x42, 0x4b, 0x48, 0x41, 0x4b, 0x44, 0x4e, 0x44,
	0x4d, 0x49, 0x4f, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
