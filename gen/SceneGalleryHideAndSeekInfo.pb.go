...
type SceneGalleryHideAndSeekInfo struct {
	...
	GCNNADABPLG []uint32 `protobuf:"varint,10,rep,packed,name=GCNNADABPLG,proto3" json:"GCNNADABPLG,omitempty"`
	GIDIOJBKDKH []uint32 `protobuf:"varint,13,rep,packed,name=GIDIOJBKDKH,proto3" json:"GIDIOJBKDKH,omitempty"`
}
...
func (x *SceneGalleryHideAndSeekInfo) GetGCNNADABPLG() []uint32 {
	if x != nil {
		return x.GCNNADABPLG
	}
	return nil
}

func (x *SceneGalleryHideAndSeekInfo) GetGIDIOJBKDKH() []uint32 {
	if x != nil {
		return x.GIDIOJBKDKH
	}
	return nil
}
...
var file_SceneGalleryHideAndSeekInfo_proto_rawDesc = []byte{
	...
	0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x43, 0x4e, 0x4e, 0x41, 0x44, 0x41, 0x42, 0x50, 0x4c,
	0x47, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x47, 0x43, 0x4e, 0x4e, 0x41, 0x44, 0x41,
	0x42, 0x50, 0x4c, 0x47, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x49, 0x44, 0x49, 0x4f, 0x4a, 0x42, 0x4b,
	0x44, 0x4b, 0x48, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x47, 0x49, 0x44, 0x49, 0x4f,
	0x4a, 0x42, 0x4b, 0x44, 0x4b, 0x48, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06,
