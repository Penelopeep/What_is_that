...
type HomeRacingRecord struct {
	...
	RecordList []*HomeRacingGalleryRecord `protobuf:"bytes,2,rep,name=record_list,json=recordList,proto3" json:"record_list,omitempty"`
}
...
var file_HomeRacingRecord_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06,
