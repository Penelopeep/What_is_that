...
type SceneGalleryInstableSprayBuffInfo struct {
	...
	JAADBLKABKF uint64 `protobuf:"varint,12,opt,name=JAADBLKABKF,proto3" json:"JAADBLKABKF,omitempty"`
	PEPAMAPELFG uint64 `protobuf:"varint,11,opt,name=PEPAMAPELFG,proto3" json:"PEPAMAPELFG,omitempty"`
...
func (x *SceneGalleryInstableSprayBuffInfo) GetJAADBLKABKF() uint64 {
	if x != nil {
		return x.JAADBLKABKF
	}
	return 0
}

func (x *SceneGalleryInstableSprayBuffInfo) GetPEPAMAPELFG() uint64 {
	if x != nil {
		return x.PEPAMAPELFG
	}
	return 0
}
...
var file_SceneGalleryInstableSprayBuffInfo_proto_rawDesc = []byte{
	...
	0x20, 0x0a, 0x0b, 0x4a, 0x41, 0x41, 0x44, 0x42, 0x4c, 0x4b, 0x41, 0x42, 0x4b, 0x46, 0x18, 0x0c,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x4a, 0x41, 0x41, 0x44, 0x42, 0x4c, 0x4b, 0x41, 0x42, 0x4b,
	0x46, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x45, 0x50, 0x41, 0x4d, 0x41, 0x50, 0x45, 0x4c, 0x46, 0x47,
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x50, 0x45, 0x50, 0x41, 0x4d, 0x41, 0x50, 0x45,
	0x4c, 0x46, 0x47, 0x12, 0x17, 0x0a, 0x07, 0x62, 0x75, 0x66, 0x66, 0x5f, 0x69, 0x64, 0x18, 0x0e,
