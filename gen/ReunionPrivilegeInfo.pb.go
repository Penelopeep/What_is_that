...
type ReunionPrivilegeInfo struct {
	...
	JHDBADNLDEJ uint32 `protobuf:"varint,5,opt,name=JHDBADNLDEJ,proto3" json:"JHDBADNLDEJ,omitempty"`
	BPDNAIHEOHE uint32 `protobuf:"varint,13,opt,name=BPDNAIHEOHE,proto3" json:"BPDNAIHEOHE,omitempty"`
}
...
func (x *ReunionPrivilegeInfo) GetJHDBADNLDEJ() uint32 {
	if x != nil {
		return x.JHDBADNLDEJ
	}
	return 0
}

func (x *ReunionPrivilegeInfo) GetBPDNAIHEOHE() uint32 {
	if x != nil {
		return x.BPDNAIHEOHE
	}
	return 0
}
...
var file_ReunionPrivilegeInfo_proto_rawDesc = []byte{
	...
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x70, 0x72, 0x69, 0x76,
	0x69, 0x6c, 0x65, 0x67, 0x65, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x4a, 0x48, 0x44, 0x42, 0x41,
	0x44, 0x4e, 0x4c, 0x44, 0x45, 0x4a, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x48,
	0x44, 0x42, 0x41, 0x44, 0x4e, 0x4c, 0x44, 0x45, 0x4a, 0x12, 0x20, 0x0a, 0x0b, 0x42, 0x50, 0x44,
	0x4e, 0x41, 0x49, 0x48, 0x45, 0x4f, 0x48, 0x45, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b,
	0x42, 0x50, 0x44, 0x4e, 0x41, 0x49, 0x48, 0x45, 0x4f, 0x48, 0x45, 0x42, 0x06, 0x5a, 0x04, 0x67,
