...
type McoinExchangeHcoinReq struct {
	...
	McoinCost uint32 `protobuf:"varint,12,opt,name=mcoin_cost,json=mcoinCost,proto3" json:"mcoin_cost,omitempty"` // PBPMGONFBPF
	Hcoin     uint32 `protobuf:"varint,13,opt,name=hcoin,proto3" json:"hcoin,omitempty"`                          // MLKHDJPCJLG
}
...
var file_McoinExchangeHcoinReq_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x68, 0x63, 0x6f, 0x69, 0x6e, 0x42, 0x06, 0x5a, 0x04, 0x67,
