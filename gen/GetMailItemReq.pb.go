...
type GetMailItemReq struct {
	...
	MailIdList []uint32 `protobuf:"varint,9,rep,packed,name=mail_id_list,json=mailIdList,proto3" json:"mail_id_list,omitempty"`
}
...
var file_GetMailItemReq_proto_rawDesc = []byte{
	...
	0x6d, 0x61, 0x69, 0x6c, 0x49, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65,
