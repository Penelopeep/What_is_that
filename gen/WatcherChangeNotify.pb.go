...
type WatcherChangeNotify struct {
	...
	KINFJNPHEMA []uint32 `protobuf:"varint,13,rep,packed,name=KINFJNPHEMA,proto3" json:"KINFJNPHEMA,omitempty"`
	CGKECCAIIED []uint32 `protobuf:"varint,5,rep,packed,name=CGKECCAIIED,proto3" json:"CGKECCAIIED,omitempty"`
}
...
func (x *WatcherChangeNotify) GetKINFJNPHEMA() []uint32 {
	if x != nil {
		return x.KINFJNPHEMA
	}
	return nil
}

func (x *WatcherChangeNotify) GetCGKECCAIIED() []uint32 {
	if x != nil {
		return x.CGKECCAIIED
	}
	return nil
}
...
var file_WatcherChangeNotify_proto_rawDesc = []byte{
	...
	0x66, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x49, 0x4e, 0x46, 0x4a, 0x4e, 0x50, 0x48, 0x45, 0x4d,
	0x41, 0x18, 0x0d, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4b, 0x49, 0x4e, 0x46, 0x4a, 0x4e, 0x50,
	0x48, 0x45, 0x4d, 0x41, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x47, 0x4b, 0x45, 0x43, 0x43, 0x41, 0x49,
	0x49, 0x45, 0x44, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x43, 0x47, 0x4b, 0x45, 0x43,
	0x43, 0x41, 0x49, 0x49, 0x45, 0x44, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06,
