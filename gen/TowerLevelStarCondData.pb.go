...
type TowerLevelStarCondData struct {
	...
	StarCondIndex uint32 `protobuf:"varint,2,opt,name=star_cond_index,json=starCondIndex,proto3" json:"star_cond_index,omitempty"` // KIGONGLABHC
	CondValue     uint32 `protobuf:"varint,4,opt,name=cond_value,json=condValue,proto3" json:"cond_value,omitempty"`               // DLEMDNGLGAP
	FGBFALDMDAB   bool   `protobuf:"varint,3,opt,name=FGBFALDMDAB,proto3" json:"FGBFALDMDAB,omitempty"`                            // FGBFALDMDAB
	KPLBFMBGPAP   bool   `protobuf:"varint,9,opt,name=KPLBFMBGPAP,proto3" json:"KPLBFMBGPAP,omitempty"`                            // KPLBFMBGPAP
}
...
func (x *TowerLevelStarCondData) GetFGBFALDMDAB() bool {
	if x != nil {
		return x.FGBFALDMDAB
	}
	return false
}

func (x *TowerLevelStarCondData) GetKPLBFMBGPAP() bool {
	if x != nil {
		return x.KPLBFMBGPAP
	}
	return false
}
...
var file_TowerLevelStarCondData_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x64, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x02, 0x20, 0x01,
	...
	0x04, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x56, 0x61, 0x6c, 0x75, 0x65,
	0x12, 0x20, 0x0a, 0x0b, 0x46, 0x47, 0x42, 0x46, 0x41, 0x4c, 0x44, 0x4d, 0x44, 0x41, 0x42, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x46, 0x47, 0x42, 0x46, 0x41, 0x4c, 0x44, 0x4d, 0x44,
	0x41, 0x42, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x50, 0x4c, 0x42, 0x46, 0x4d, 0x42, 0x47, 0x50, 0x41,
	0x50, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x4b, 0x50, 0x4c, 0x42, 0x46, 0x4d, 0x42,
	0x47, 0x50, 0x41, 0x50, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
