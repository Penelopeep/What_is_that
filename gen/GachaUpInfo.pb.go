...
type GachaUpInfo struct {
	...
	ItemParentType uint32   `protobuf:"varint,8,opt,name=item_parent_type,json=itemParentType,proto3" json:"item_parent_type,omitempty"`
...
var file_GachaUpInfo_proto_rawDesc = []byte{
	...
	0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x69, 0x74,
