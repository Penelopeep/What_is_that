...
type GetDailyDungeonEntryInfoRsp struct {
	...
	DailyDungeonInfoList []*DailyDungeonEntryInfo `protobuf:"bytes,15,rep,name=daily_dungeon_info_list,json=dailyDungeonInfoList,proto3" json:"daily_dungeon_info_list,omitempty"`
