...
type BrickBreakerActivityStageInfo struct {
	...
	DDLJNDKFPHP bool   `protobuf:"varint,7,opt,name=DDLJNDKFPHP,proto3" json:"DDLJNDKFPHP,omitempty"`
	StageId     uint32 `protobuf:"varint,9,opt,name=stage_id,json=stageId,proto3" json:"stage_id,omitempty"`
	LIGDBOAIDJN bool   `protobuf:"varint,10,opt,name=LIGDBOAIDJN,proto3" json:"LIGDBOAIDJN,omitempty"`
}
...
func (x *BrickBreakerActivityStageInfo) GetDDLJNDKFPHP() bool {
	if x != nil {
		return x.DDLJNDKFPHP
	}
	return false
}
...
func (x *BrickBreakerActivityStageInfo) GetLIGDBOAIDJN() bool {
	if x != nil {
		return x.LIGDBOAIDJN
	}
	return false
}
...
var file_BrickBreakerActivityStageInfo_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x44, 0x44, 0x4c, 0x4a, 0x4e, 0x44,
	0x4b, 0x46, 0x50, 0x48, 0x50, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x44, 0x44, 0x4c,
	0x4a, 0x4e, 0x44, 0x4b, 0x46, 0x50, 0x48, 0x50, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x67,
	0x65, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x73, 0x74, 0x61, 0x67,
	0x65, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x4c, 0x49, 0x47, 0x44, 0x42, 0x4f, 0x41, 0x49, 0x44,
	0x4a, 0x4e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x4c, 0x49, 0x47, 0x44, 0x42, 0x4f,
	0x41, 0x49, 0x44, 0x4a, 0x4e, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06, 0x70,
