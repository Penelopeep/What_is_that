...
type IrodoriEditFlowerCombinationRsp struct {
	...
	NCECAIKEDLC bool  `protobuf:"varint,15,opt,name=NCECAIKEDLC,proto3" json:"NCECAIKEDLC,omitempty"`
	Retcode     int32 `protobuf:"varint,6,opt,name=retcode,proto3" json:"retcode,omitempty"`
	GJMFJJEFFHH bool  `protobuf:"varint,4,opt,name=GJMFJJEFFHH,proto3" json:"GJMFJJEFFHH,omitempty"`
}
...
func (x *IrodoriEditFlowerCombinationRsp) GetNCECAIKEDLC() bool {
	if x != nil {
		return x.NCECAIKEDLC
	}
	return false
}
...
func (x *IrodoriEditFlowerCombinationRsp) GetGJMFJJEFFHH() bool {
	if x != nil {
		return x.GJMFJJEFFHH
	}
	return false
}
...
var file_IrodoriEditFlowerCombinationRsp_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x73, 0x70, 0x12, 0x20, 0x0a, 0x0b, 0x4e, 0x43,
	0x45, 0x43, 0x41, 0x49, 0x4b, 0x45, 0x44, 0x4c, 0x43, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0b, 0x4e, 0x43, 0x45, 0x43, 0x41, 0x49, 0x4b, 0x45, 0x44, 0x4c, 0x43, 0x12, 0x18, 0x0a, 0x07,
	0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x72,
	0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x47, 0x4a, 0x4d, 0x46, 0x4a, 0x4a,
	0x45, 0x46, 0x46, 0x48, 0x48, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x47, 0x4a, 0x4d,
	0x46, 0x4a, 0x4a, 0x45, 0x46, 0x46, 0x48, 0x48, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f,
