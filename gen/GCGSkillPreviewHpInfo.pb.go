...
type GCGSkillPreviewHpInfo struct {
	...
	ChangeType    GCGSkillHpChangeType `protobuf:"varint,5,opt,name=change_type,json=changeType,proto3,enum=GCGSkillHpChangeType" json:"change_type,omitempty"`
	HpChangeValue uint32               `protobuf:"varint,10,opt,name=hp_change_value,json=hpChangeValue,proto3" json:"hp_change_value,omitempty"`
}
...
var file_GCGSkillPreviewHpInfo_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e, 0x47, 0x43, 0x47, 0x53, 0x6b, 0x69,
	...
	0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x0a, 0x20,
