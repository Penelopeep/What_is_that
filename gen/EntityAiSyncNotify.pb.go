...
type EntityAiSyncNotify struct {
	...
	LocalAvatarAlertedMonsterList []uint32      `protobuf:"varint,7,rep,packed,name=local_avatar_alerted_monster_list,json=localAvatarAlertedMonsterList,proto3" json:"local_avatar_alerted_monster_list,omitempty"`
	InfoList                      []*AiSyncInfo `protobuf:"bytes,3,rep,name=info_list,json=infoList,proto3" json:"info_list,omitempty"`
}
...
var file_EntityAiSyncNotify_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x1d,
