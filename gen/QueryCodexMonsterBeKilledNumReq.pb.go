...
type QueryCodexMonsterBeKilledNumReq struct {
	...
	CodexIdList []uint32 `protobuf:"varint,13,rep,packed,name=codex_id_list,json=codexIdList,proto3" json:"codex_id_list,omitempty"`
}
...
var file_QueryCodexMonsterBeKilledNumReq_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x78, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x0d, 0x20, 0x03, 0x28,
