...
type QuickUseWidgetReq struct {
	...
	GPAEJDBAELH bool `protobuf:"varint,1846,opt,name=GPAEJDBAELH,proto3" json:"GPAEJDBAELH,omitempty"`
...
func (x *QuickUseWidgetReq) GetGPAEJDBAELH() bool {
	if x != nil {
		return x.GPAEJDBAELH
	}
	return false
}
...
type QuickUseWidgetReq_LocationInfo struct {
	LocationInfo *WidgetCreateLocationInfo `protobuf:"bytes,1807,opt,name=location_info,json=locationInfo,proto3,oneof"`
}

type QuickUseWidgetReq_CameraInfo struct {
	CameraInfo *WidgetCameraInfo `protobuf:"bytes,1828,opt,name=camera_info,json=cameraInfo,proto3,oneof"`
}

type QuickUseWidgetReq_CreatorInfo struct {
	CreatorInfo *WidgetCreatorInfo `protobuf:"bytes,1560,opt,name=creator_info,json=creatorInfo,proto3,oneof"`
}

type QuickUseWidgetReq_ThunderBirdFeatherInfo struct {
	ThunderBirdFeatherInfo *WidgetThunderBirdFeatherInfo `protobuf:"bytes,1431,opt,name=thunder_bird_feather_info,json=thunderBirdFeatherInfo,proto3,oneof"`
}

type QuickUseWidgetReq_SorushInfo struct {
	SorushInfo *WidgetSorushInfo `protobuf:"bytes,1961,opt,name=sorush_info,json=sorushInfo,proto3,oneof"`
}
...
var file_QuickUseWidgetReq_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x16, 0x57, 0x69, 0x64, 0x67,
	0x65, 0x74, 0x53, 0x6f, 0x72, 0x75, 0x73, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x1a, 0x22, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74, 0x54, 0x68, 0x75, 0x6e, 0x64, 0x65,
	...
	0x47, 0x50, 0x41, 0x45, 0x4a, 0x44, 0x42, 0x41, 0x45, 0x4c, 0x48, 0x18, 0xb6, 0x0e, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x0b, 0x47, 0x50, 0x41, 0x45, 0x4a, 0x44, 0x42, 0x41, 0x45, 0x4c, 0x48, 0x12,
	0x41, 0x0a, 0x0d, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x66, 0x6f,
	0x18, 0x8f, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74,
	...
	0x6f, 0x18, 0xa4, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x57, 0x69, 0x64, 0x67, 0x65,
	...
	0x61, 0x74, 0x6f, 0x72, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x98, 0x0c, 0x20, 0x01, 0x28, 0x0b,
	...
	0x18, 0x97, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74,
	...
	0x72, 0x42, 0x69, 0x72, 0x64, 0x46, 0x65, 0x61, 0x74, 0x68, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f,
	0x12, 0x35, 0x0a, 0x0b, 0x73, 0x6f, 0x72, 0x75, 0x73, 0x68, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	0xa9, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x57, 0x69, 0x64, 0x67, 0x65, 0x74, 0x53,
	0x6f, 0x72, 0x75, 0x73, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x48, 0x00, 0x52, 0x0a, 0x73, 0x6f, 0x72,
	0x75, 0x73, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x07, 0x0a, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d,
