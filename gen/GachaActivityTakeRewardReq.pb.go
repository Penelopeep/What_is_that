...
type GachaActivityTakeRewardReq struct {
	...
	RobotNumMap map[uint32]uint32 `protobuf:"bytes,6,rep,name=robot_num_map,json=robotNumMap,proto3" json:"robot_num_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
var file_GachaActivityTakeRewardReq_proto_rawDesc = []byte{
	...
	0x61, 0x70, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x47, 0x61, 0x63, 0x68, 0x61,
