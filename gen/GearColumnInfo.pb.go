...
type GearColumnInfo struct {
	...
	HHKCHFDLAMO uint32 `protobuf:"varint,2,opt,name=HHKCHFDLAMO,proto3" json:"HHKCHFDLAMO,omitempty"`
	IGLHBIKHHFL bool   `protobuf:"varint,8,opt,name=IGLHBIKHHFL,proto3" json:"IGLHBIKHHFL,omitempty"`
	EJJFGFOKOPC bool   `protobuf:"varint,10,opt,name=EJJFGFOKOPC,proto3" json:"EJJFGFOKOPC,omitempty"`
	LCHKEEDFCCL uint32 `protobuf:"varint,3,opt,name=LCHKEEDFCCL,proto3" json:"LCHKEEDFCCL,omitempty"`
}
...
func (x *GearColumnInfo) GetHHKCHFDLAMO() uint32 {
	if x != nil {
		return x.HHKCHFDLAMO
	}
	return 0
}

func (x *GearColumnInfo) GetIGLHBIKHHFL() bool {
	if x != nil {
		return x.IGLHBIKHHFL
	}
	return false
}

func (x *GearColumnInfo) GetEJJFGFOKOPC() bool {
	if x != nil {
		return x.EJJFGFOKOPC
	}
	return false
}

func (x *GearColumnInfo) GetLCHKEEDFCCL() uint32 {
	if x != nil {
		return x.LCHKEEDFCCL
	}
	return 0
}
...
var file_GearColumnInfo_proto_rawDesc = []byte{
	...
	,
