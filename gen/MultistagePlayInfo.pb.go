...
type MultistagePlayInfo struct {
	...
	StageIndex uint32 `protobuf:"varint,2,opt,name=stage_index,json=stageIndex,proto3" json:"stage_index,omitempty"`
...
type MultistagePlayInfo_MechanicusInfo struct {
	MechanicusInfo *InBattleMechanicusInfo `protobuf:"bytes,126,opt,name=mechanicus_info,json=mechanicusInfo,proto3,oneof"`
}

type MultistagePlayInfo_FleurFairInfo struct {
	FleurFairInfo *InBattleFleurFairInfo `protobuf:"bytes,604,opt,name=fleur_fair_info,json=fleurFairInfo,proto3,oneof"`
}

type MultistagePlayInfo_HideAndSeekInfo struct {
	HideAndSeekInfo *HideAndSeekStageInfo `protobuf:"bytes,1873,opt,name=hide_and_seek_info,json=hideAndSeekInfo,proto3,oneof"`
}

type MultistagePlayInfo_ChessInfo struct {
	ChessInfo *InBattleChessInfo `protobuf:"bytes,167,opt,name=chess_info,json=chessInfo,proto3,oneof"`
}

type MultistagePlayInfo_IrodoriChessInfo struct {
	IrodoriChessInfo *InBattleIrodoriChessInfo `protobuf:"bytes,1680,opt,name=irodori_chess_info,json=irodoriChessInfo,proto3,oneof"`
}

type MultistagePlayInfo_CharAmusementInfo struct {
	CharAmusementInfo *CharAmusementInfo `protobuf:"bytes,193,opt,name=char_amusement_info,json=charAmusementInfo,proto3,oneof"`
}

type MultistagePlayInfo_BrickBreakerInfo struct {
	BrickBreakerInfo *BrickBreakerStageInfo `protobuf:"bytes,1784,opt,name=brick_breaker_info,json=brickBreakerInfo,proto3,oneof"`
}

type MultistagePlayInfo_CoinCollectInfo struct {
	CoinCollectInfo *CoinCollectStageInfo `protobuf:"bytes,1813,opt,name=coin_collect_info,json=coinCollectInfo,proto3,oneof"`
}

type MultistagePlayInfo_LanV3BoatInfo struct {
	LanV3BoatInfo *LanV3BoatStageInfo `protobuf:"bytes,1754,opt,name=lan_v3_boat_info,json=lanV3BoatInfo,proto3,oneof"`
}

type MultistagePlayInfo_FleurFairV2PacmanInfo struct {
	FleurFairV2PacmanInfo *FleurFairV2PacmanStageInfo `protobuf:"bytes,1281,opt,name=fleur_fair_v2_pacman_info,json=fleurFairV2PacmanInfo,proto3,oneof"`
}
...
var file_MultistagePlayInfo_proto_rawDesc = []byte{
	...
	,
	...
	0x01, 0x28, 0x0d, 0x52, 0x09, 0x62, 0x65, 0x67, 0x69, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1d,
	0x0a, 0x0a, 0x73, 0x74, 0x61, 0x67, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x09, 0x73, 0x74, 0x61, 0x67, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a,
	0x0a, 0x70, 0x6c, 0x61, 0x79, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x0a, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	,
