...
type AddRandTaskInfoNotify struct {
	...
	RandTaskId uint32  `protobuf:"varint,2,opt,name=rand_task_id,json=randTaskId,proto3" json:"rand_task_id,omitempty"`
}
...
var file_AddRandTaskInfoNotify_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x72, 0x61, 0x6e, 0x64, 0x54, 0x61, 0x73, 0x6b, 0x49,
