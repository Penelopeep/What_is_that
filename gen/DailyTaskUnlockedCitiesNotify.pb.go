...
type DailyTaskUnlockedCitiesNotify struct {
	...
	UnlockedCityList []uint32 `protobuf:"varint,6,rep,packed,name=unlocked_city_list,json=unlockedCityList,proto3" json:"unlocked_city_list,omitempty"`
}
...
var file_DailyTaskUnlockedCitiesNotify_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x5f, 0x63, 0x69, 0x74, 0x79, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03,
