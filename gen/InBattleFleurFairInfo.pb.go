...
type InBattleFleurFairInfo struct {
	...
	KNJNIILLBNC uint32   `protobuf:"varint,6,opt,name=KNJNIILLBNC,proto3" json:"KNJNIILLBNC,omitempty"`
	CHLKFGNAEBL []uint32 `protobuf:"varint,14,rep,packed,name=CHLKFGNAEBL,proto3" json:"CHLKFGNAEBL,omitempty"`
	NNMCCEGMNLK []uint32 `protobuf:"varint,8,rep,packed,name=NNMCCEGMNLK,proto3" json:"NNMCCEGMNLK,omitempty"`
	DDGOJCJLFAM uint32   `protobuf:"varint,4,opt,name=DDGOJCJLFAM,proto3" json:"DDGOJCJLFAM,omitempty"`
	DJOFKGFMBKK uint32   `protobuf:"varint,3,opt,name=DJOFKGFMBKK,proto3" json:"DJOFKGFMBKK,omitempty"`
}
...
func (x *InBattleFleurFairInfo) GetKNJNIILLBNC() uint32 {
	if x != nil {
		return x.KNJNIILLBNC
	}
	return 0
}

func (x *InBattleFleurFairInfo) GetCHLKFGNAEBL() []uint32 {
	if x != nil {
		return x.CHLKFGNAEBL
	}
	return nil
}

func (x *InBattleFleurFairInfo) GetNNMCCEGMNLK() []uint32 {
	if x != nil {
		return x.NNMCCEGMNLK
	}
	return nil
}

func (x *InBattleFleurFairInfo) GetDDGOJCJLFAM() uint32 {
	if x != nil {
		return x.DDGOJCJLFAM
	}
	return 0
}

func (x *InBattleFleurFairInfo) GetDJOFKGFMBKK() uint32 {
	if x != nil {
		return x.DJOFKGFMBKK
	}
	return 0
}
...
var file_InBattleFleurFairInfo_proto_rawDesc = []byte{
	...
	,
}
