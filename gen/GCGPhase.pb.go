...
type GCGPhase struct {
	...
	AllowControllerMap map[uint32]uint32 `protobuf:"bytes,14,rep,name=allow_controller_map,json=allowControllerMap,proto3" json:"allow_controller_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	PhaseType          GCGPhaseType      `protobuf:"varint,10,opt,name=phase_type,json=phaseType,proto3,enum=GCGPhaseType" json:"phase_type,omitempty"`
}
...
var file_GCGPhase_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x6c, 0x65, 0x72, 0x4d, 0x61, 0x70, 0x12, 0x2c, 0x0a, 0x0a, 0x70, 0x68, 0x61, 0x73, 0x65, 0x5f,
	0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x47, 0x43, 0x47,
	0x50, 0x68, 0x61, 0x73, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x09, 0x70, 0x68, 0x61, 0x73, 0x65,
	0x54, 0x79, 0x70, 0x65, 0x1a, 0x45, 0x0a, 0x17, 0x41, 0x6c, 0x6c, 0x6f, 0x77, 0x43, 0x6f, 0x6e,
...
var file_GCGPhase_proto_depIdxs = []int32{
	...
	2, // 1: GCGPhase.phase_type:type_name -> GCGPhaseType
