...
type GCGOperation_OpRedraw struct {
	OpRedraw *GCGOperationRedraw `protobuf:"bytes,13,opt,name=op_redraw,json=opRedraw,proto3,oneof"`
}

type GCGOperation_OpSelectOnStage struct {
	OpSelectOnStage *GCGOperationOnStageSelect `protobuf:"bytes,5,opt,name=op_select_on_stage,json=opSelectOnStage,proto3,oneof"`
}

type GCGOperation_OpReroll struct {
	OpReroll *GCGOperationReroll `protobuf:"bytes,7,opt,name=op_reroll,json=opReroll,proto3,oneof"`
}
...
type GCGOperation_OpPass struct {
	OpPass *GCGOperationPass `protobuf:"bytes,14,opt,name=op_pass,json=opPass,proto3,oneof"`
}
...
type GCGOperation_OpReboot struct {
	OpReboot *GCGOperationReboot `protobuf:"bytes,10,opt,name=op_reboot,json=opReboot,proto3,oneof"`
}
...
var file_GCGOperation_proto_rawDesc = []byte{
	...
	0x32, 0x0a, 0x09, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x64, 0x72, 0x61, 0x77, 0x18, 0x0d, 0x20, 0x01,
	...
	0x5f, 0x6f, 0x6e, 0x5f, 0x73, 0x74, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x0a, 0x09, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x72, 0x6f, 0x6c, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x73, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x47, 0x43, 0x47, 0x4f, 0x70, 0x65,
	...
	0x32, 0x0a, 0x09, 0x6f, 0x70, 0x5f, 0x72, 0x65, 0x62, 0x6f, 0x6f, 0x74, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x13, 0x2e, 0x47, 0x43, 0x47, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f,
	...
	0x42, 0x04, 0x0a, 0x02, 0x6f, 0x70, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06,
