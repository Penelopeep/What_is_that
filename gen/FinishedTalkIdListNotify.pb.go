...
type FinishedTalkIdListNotify struct {
	...
	FinishedTalkIdList []uint32 `protobuf:"varint,3,rep,packed,name=finished_talk_id_list,json=finishedTalkIdList,proto3" json:"finished_talk_id_list,omitempty"`
}
...
var file_FinishedTalkIdListNotify_proto_rawDesc = []byte{
	...
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x12, 0x66, 0x69, 0x6e,
