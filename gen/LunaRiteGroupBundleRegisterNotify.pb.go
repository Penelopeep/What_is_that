...
type LunaRiteGroupBundleRegisterNotify struct {
	...
	GroupLinkBundleId uint32 `protobuf:"varint,1,opt,name=group_link_bundle_id,json=groupLinkBundleId,proto3" json:"group_link_bundle_id,omitempty"`
}
...
var file_LunaRiteGroupBundleRegisterNotify_proto_rawDesc = []byte{
	...
	0x64, 0x6c, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x11, 0x67, 0x72,
