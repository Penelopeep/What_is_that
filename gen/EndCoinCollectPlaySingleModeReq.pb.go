...
type EndCoinCollectPlaySingleModeReq struct {
	...
	MultistagePlayIndex uint32 `protobuf:"varint,7,opt,name=multistage_play_index,json=multistagePlayIndex,proto3" json:"multistage_play_index,omitempty"`
}
...
var file_EndCoinCollectPlaySingleModeReq_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x78, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x13, 0x6d, 0x75, 0x6c, 0x74, 0x69,
