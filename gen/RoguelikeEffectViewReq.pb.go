...
type RoguelikeEffectViewReq struct {
	...
	KLHGFELAILA []uint32 `protobuf:"varint,8,rep,packed,name=KLHGFELAILA,proto3" json:"KLHGFELAILA,omitempty"`
	MKFIGOJPBGP []uint32 `protobuf:"varint,1,rep,packed,name=MKFIGOJPBGP,proto3" json:"MKFIGOJPBGP,omitempty"`
}
...
func (x *RoguelikeEffectViewReq) GetKLHGFELAILA() []uint32 {
	if x != nil {
		return x.KLHGFELAILA
	}
	return nil
}

func (x *RoguelikeEffectViewReq) GetMKFIGOJPBGP() []uint32 {
	if x != nil {
		return x.MKFIGOJPBGP
	}
	return nil
}
...
var file_RoguelikeEffectViewReq_proto_rawDesc = []byte{
	...
	0x74, 0x56, 0x69, 0x65, 0x77, 0x52, 0x65, 0x71, 0x12, 0x20, 0x0a, 0x0b, 0x4b, 0x4c, 0x48, 0x47,
	0x46, 0x45, 0x4c, 0x41, 0x49, 0x4c, 0x41, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4b,
	0x4c, 0x48, 0x47, 0x46, 0x45, 0x4c, 0x41, 0x49, 0x4c, 0x41, 0x12, 0x20, 0x0a, 0x0b, 0x4d, 0x4b,
	0x46, 0x49, 0x47, 0x4f, 0x4a, 0x50, 0x42, 0x47, 0x50, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52,
	0x0b, 0x4d, 0x4b, 0x46, 0x49, 0x47, 0x4f, 0x4a, 0x50, 0x42, 0x47, 0x50, 0x42, 0x06, 0x5a, 0x04,
