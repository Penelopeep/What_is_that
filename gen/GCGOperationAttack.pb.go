...
type GCGOperationAttack struct {
	...
	CostDiceIndexList []uint32 `protobuf:"varint,9,rep,packed,name=cost_dice_index_list,json=costDiceIndexList,proto3" json:"cost_dice_index_list,omitempty"`
}
...
var file_GCGOperationAttack_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x11, 0x63, 0x6f, 0x73, 0x74, 0x44,
