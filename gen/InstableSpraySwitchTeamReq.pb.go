...
type InstableSpraySwitchTeamReq struct {
	...
	AvatarInfoList []*InstableSprayAvatarInfo `protobuf:"bytes,8,rep,name=avatar_info_list,json=avatarInfoList,proto3" json:"avatar_info_list,omitempty"`
}
...
var file_InstableSpraySwitchTeamReq_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x49, 0x6e, 0x73, 0x74,
