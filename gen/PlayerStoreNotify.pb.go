...
type PlayerStoreNotify struct {
	...
	ItemList    []*Item   `protobuf:"bytes,9,rep,name=item_list,json=itemList,proto3" json:"item_list,omitempty"`
	WeightLimit uint32    `protobuf:"varint,11,opt,name=weight_limit,json=weightLimit,proto3" json:"weight_limit,omitempty"`
	StoreType   StoreType `protobuf:"varint,5,opt,name=store_type,json=storeType,proto3,enum=StoreType" json:"store_type,omitempty"`
}
...
var file_PlayerStoreNotify_proto_rawDesc = []byte{
	...
	0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x4c, 0x69,
	0x6d, 0x69, 0x74, 0x12, 0x29, 0x0a, 0x0a, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x54,
