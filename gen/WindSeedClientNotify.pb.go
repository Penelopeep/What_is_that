...
type WindSeedClientNotify_RefreshNotify_ struct {
	RefreshNotify *WindSeedClientNotify_RefreshNotify `protobuf:"bytes,12,opt,name=refresh_notify,json=refreshNotify,proto3,oneof"`
}
...
type WindSeedClientNotify_AreaNotify_ struct {
	AreaNotify *WindSeedClientNotify_AreaNotify `protobuf:"bytes,2,opt,name=area_notify,json=areaNotify,proto3,oneof"`
}
...
type WindSeedClientNotify_AddWindBulletNotify struct {
	...
	JGDLMEEEBIM uint32  `protobuf:"varint,10,opt,name=JGDLMEEEBIM,proto3" json:"JGDLMEEEBIM,omitempty"`
	ALLPEAAMOLB uint32  `protobuf:"varint,3,opt,name=ALLPEAAMOLB,proto3" json:"ALLPEAAMOLB,omitempty"`
}
...
func (x *WindSeedClientNotify_AddWindBulletNotify) GetJGDLMEEEBIM() uint32 {
	if x != nil {
		return x.JGDLMEEEBIM
	}
	return 0
}

func (x *WindSeedClientNotify_AddWindBulletNotify) GetALLPEAAMOLB() uint32 {
	if x != nil {
		return x.ALLPEAAMOLB
	}
	return 0
}
...
var file_WindSeedClientNotify_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x69, 0x66, 0x79, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x57, 0x69,
	...
	0x66, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x57, 0x69, 0x6e, 0x64, 0x53,
	...
	0x65, 0x64, 0x50, 0x6f, 0x73, 0x12, 0x20, 0x0a, 0x0b, 0x4a, 0x47, 0x44, 0x4c, 0x4d, 0x45, 0x45,
	0x45, 0x42, 0x49, 0x4d, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x47, 0x44, 0x4c,
	0x4d, 0x45, 0x45, 0x45, 0x42, 0x49, 0x4d, 0x12, 0x20, 0x0a, 0x0b, 0x41, 0x4c, 0x4c, 0x50, 0x45,
	0x41, 0x41, 0x4d, 0x4f, 0x4c, 0x42, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x41, 0x4c,
	0x4c, 0x50, 0x45, 0x41, 0x41, 0x4d, 0x4f, 0x4c, 0x42, 0x1a, 0x5f, 0x0a, 0x0a, 0x41, 0x72, 0x65,
	0x61, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x79, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x72, 0x65, 0x61, 0x5f,
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x61, 0x72, 0x65, 0x61, 0x49, 0x64,
	...
	0x09, 0x61, 0x72, 0x65, 0x61, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c,
