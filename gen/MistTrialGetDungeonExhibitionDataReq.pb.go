...
type MistTrialGetDungeonExhibitionDataReq struct {
	...
	TrialId uint32 `protobuf:"varint,8,opt,name=trial_id,json=trialId,proto3" json:"trial_id,omitempty"`
}
...
var file_MistTrialGetDungeonExhibitionDataReq_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x49, 0x64, 0x42,
