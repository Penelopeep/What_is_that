...
type FishingGallerySettleInfo struct {
	...
	FishMap          map[uint32]*FishInfo `protobuf:"bytes,14,rep,name=fish_map,json=fishMap,proto3" json:"fish_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_FishingGallerySettleInfo_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x66, 0x69, 0x73, 0x68, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x0b,
