...
type ArenaChallengeFinishNotify struct {
	...
	ChildChallengeList []*ArenaChallengeChildChallengeInfo `protobuf:"bytes,6,rep,name=child_challenge_list,json=childChallengeList,proto3" json:"child_challenge_list,omitempty"`
	GELFIDPMHLJ        uint32                              `protobuf:"varint,15,opt,name=GELFIDPMHLJ,proto3" json:"GELFIDPMHLJ,omitempty"`
	FCLFLMPGIKN        uint32                              `protobuf:"varint,2,opt,name=FCLFLMPGIKN,proto3" json:"FCLFLMPGIKN,omitempty"`
}
...
func (x *ArenaChallengeFinishNotify) GetGELFIDPMHLJ() uint32 {
	if x != nil {
		return x.GELFIDPMHLJ
	}
	return 0
}

func (x *ArenaChallengeFinishNotify) GetFCLFLMPGIKN() uint32 {
	if x != nil {
		return x.FCLFLMPGIKN
	}
	return 0
}
...
var file_ArenaChallengeFinishNotify_proto_rawDesc = []byte{
	...
	0x73, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x53, 0x0a, 0x14, 0x63, 0x68, 0x69, 0x6c,
	0x64, 0x5f, 0x63, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x5f, 0x6c, 0x69, 0x73, 0x74,
	0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x41, 0x72, 0x65, 0x6e, 0x61, 0x43, 0x68,
	...
	0x43, 0x68, 0x61, 0x6c, 0x6c, 0x65, 0x6e, 0x67, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x20, 0x0a,
	0x0b, 0x47, 0x45, 0x4c, 0x46, 0x49, 0x44, 0x50, 0x4d, 0x48, 0x4c, 0x4a, 0x18, 0x0f, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x47, 0x45, 0x4c, 0x46, 0x49, 0x44, 0x50, 0x4d, 0x48, 0x4c, 0x4a, 0x12,
	0x20, 0x0a, 0x0b, 0x46, 0x43, 0x4c, 0x46, 0x4c, 0x4d, 0x50, 0x47, 0x49, 0x4b, 0x4e, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x46, 0x43, 0x4c, 0x46, 0x4c, 0x4d, 0x50, 0x47, 0x49, 0x4b,
