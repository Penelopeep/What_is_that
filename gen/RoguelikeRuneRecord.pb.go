...
type RoguelikeRuneRecord struct {
	...
	FNOMMOAFCHG uint32 `protobuf:"varint,11,opt,name=FNOMMOAFCHG,proto3" json:"FNOMMOAFCHG,omitempty"`
	RuneId      uint32 `protobuf:"varint,10,opt,name=rune_id,json=runeId,proto3" json:"rune_id,omitempty"`
	EGIKJBIOOCF uint32 `protobuf:"varint,15,opt,name=EGIKJBIOOCF,proto3" json:"EGIKJBIOOCF,omitempty"`
}
...
func (x *RoguelikeRuneRecord) GetFNOMMOAFCHG() uint32 {
	if x != nil {
		return x.FNOMMOAFCHG
	}
	return 0
}
...
func (x *RoguelikeRuneRecord) GetEGIKJBIOOCF() uint32 {
	if x != nil {
		return x.EGIKJBIOOCF
	}
	return 0
}
...
var file_RoguelikeRuneRecord_proto_rawDesc = []byte{
	...
	0x72, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x46, 0x4e, 0x4f, 0x4d, 0x4d, 0x4f, 0x41, 0x46, 0x43, 0x48,
	0x47, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x46, 0x4e, 0x4f, 0x4d, 0x4d, 0x4f, 0x41,
	0x46, 0x43, 0x48, 0x47, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x75, 0x6e, 0x65, 0x5f, 0x69, 0x64, 0x18,
	0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x72, 0x75, 0x6e, 0x65, 0x49, 0x64, 0x12, 0x20, 0x0a,
	0x0b, 0x45, 0x47, 0x49, 0x4b, 0x4a, 0x42, 0x49, 0x4f, 0x4f, 0x43, 0x46, 0x18, 0x0f, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0b, 0x45, 0x47, 0x49, 0x4b, 0x4a, 0x42, 0x49, 0x4f, 0x4f, 0x43, 0x46, 0x42,
