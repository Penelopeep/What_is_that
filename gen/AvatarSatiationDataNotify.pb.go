...
type AvatarSatiationDataNotify struct {
	...
	SatiationDataList []*AvatarSatiationData `protobuf:"bytes,8,rep,name=satiation_data_list,json=satiationDataList,proto3" json:"satiation_data_list,omitempty"`
}
...
var file_AvatarSatiationDataNotify_proto_rawDesc = []byte{
	...
	0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x53,
