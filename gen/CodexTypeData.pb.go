...
type CodexTypeData struct {
	...
	CodexIdList              []uint32          `protobuf:"varint,1,rep,packed,name=codex_id_list,json=codexIdList,proto3" json:"codex_id_list,omitempty"`
	WeaponMaxPromoteLevelMap map[uint32]uint32 `protobuf:"bytes,10,rep,name=weapon_max_promote_level_map,json=weaponMaxPromoteLevelMap,proto3" json:"weapon_max_promote_level_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	Type                     CodexType         `protobuf:"varint,8,opt,name=type,proto3,enum=CodexType" json:"type,omitempty"`
	HaveViewedList           []bool            `protobuf:"varint,6,rep,packed,name=have_viewed_list,json=haveViewedList,proto3" json:"have_viewed_list,omitempty"`
}
...
var file_CodexTypeData_proto_rawDesc = []byte{
	...
	0x78, 0x5f, 0x69, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0d, 0x52,
	...
	0x74, 0x65, 0x5f, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0a, 0x20, 0x03,
	...
	0x70, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0a, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x78,
	0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x28, 0x0a, 0x10, 0x68, 0x61,
	0x76, 0x65, 0x5f, 0x76, 0x69, 0x65, 0x77, 0x65, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06,
