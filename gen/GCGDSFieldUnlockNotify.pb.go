...
type GCGDSFieldUnlockNotify struct {
	...
	FieldId uint32 `protobuf:"varint,15,opt,name=field_id,json=fieldId,proto3" json:"field_id,omitempty"`
}
...
var file_GCGDSFieldUnlockNotify_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x69, 0x64, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x66, 0x69, 0x65, 0x6c,
