...
type NpcTalkRsp struct {
	...
	CurTalkId   uint32 `protobuf:"varint,3,opt,name=cur_talk_id,json=curTalkId,proto3" json:"cur_talk_id,omitempty"`
	Retcode     int32  `protobuf:"varint,12,opt,name=retcode,proto3" json:"retcode,omitempty"`
	NpcEntityId uint32 `protobuf:"varint,8,opt,name=npc_entity_id,json=npcEntityId,proto3" json:"npc_entity_id,omitempty"`
}
...
var file_NpcTalkRsp_proto_rawDesc = []byte{
	...
	0x70, 0x12, 0x1b, 0x0a, 0x09, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x69, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x1e,
	0x0a, 0x0b, 0x63, 0x75, 0x72, 0x5f, 0x74, 0x61, 0x6c, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
