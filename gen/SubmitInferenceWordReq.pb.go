...
type SubmitInferenceWordReq struct {
	...
	PageId uint32 `protobuf:"varint,14,opt,name=page_id,json=pageId,proto3" json:"page_id,omitempty"`
...
var file_SubmitInferenceWordReq_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x64, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x70, 0x61, 0x67, 0x65, 0x49,
