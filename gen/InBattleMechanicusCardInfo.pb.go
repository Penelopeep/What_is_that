...
type InBattleMechanicusCardInfo struct {
	...
	AMLCAOLJCHK    uint32                               `protobuf:"varint,8,opt,name=AMLCAOLJCHK,proto3" json:"AMLCAOLJCHK,omitempty"`
	CardId         uint32                               `protobuf:"varint,1,opt,name=card_id,json=cardId,proto3" json:"card_id,omitempty"`
	PIIOIDEHFDD    uint32                               `protobuf:"varint,3,opt,name=PIIOIDEHFDD,proto3" json:"PIIOIDEHFDD,omitempty"`
	DEGFCIHNLEG    uint32                               `protobuf:"varint,6,opt,name=DEGFCIHNLEG,proto3" json:"DEGFCIHNLEG,omitempty"`
	ChallengeState InBattleMechanicusCardChallengeState `protobuf:"varint,14,opt,name=challenge_state,json=challengeState,proto3,enum=InBattleMechanicusCardChallengeState" json:"challenge_state,omitempty"`
	CostPoints     uint32                               `protobuf:"varint,10,opt,name=cost_points,json=costPoints,proto3" json:"cost_points,omitempty"`
}
...
func (x *InBattleMechanicusCardInfo) GetAMLCAOLJCHK() uint32 {
	if x != nil {
		return x.AMLCAOLJCHK
	}
	return 0
}
...
func (x *InBattleMechanicusCardInfo) GetPIIOIDEHFDD() uint32 {
	if x != nil {
		return x.PIIOIDEHFDD
	}
	return 0
}

func (x *InBattleMechanicusCardInfo) GetDEGFCIHNLEG() uint32 {
	if x != nil {
		return x.DEGFCIHNLEG
	}
	return 0
}
...
var file_InBattleMechanicusCardInfo_proto_rawDesc = []byte{
	...
	,
