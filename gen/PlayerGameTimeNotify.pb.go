...
type PlayerGameTimeNotify struct {
	...
	IsHome   bool   `protobuf:"varint,14,opt,name=is_home,json=isHome,proto3" json:"is_home,omitempty"`
}
...
var file_PlayerGameTimeNotify_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x68, 0x6f, 0x6d, 0x65, 0x18, 0x0e,
