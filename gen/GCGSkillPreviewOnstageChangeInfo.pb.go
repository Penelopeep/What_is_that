...
type GCGSkillPreviewOnstageChangeInfo struct {
	...
	MBGBIHBOPIF uint32 `protobuf:"varint,8,opt,name=MBGBIHBOPIF,proto3" json:"MBGBIHBOPIF,omitempty"`
	IJBIHEKEEHD uint32 `protobuf:"varint,3,opt,name=IJBIHEKEEHD,proto3" json:"IJBIHEKEEHD,omitempty"`
}
...
func (x *GCGSkillPreviewOnstageChangeInfo) GetMBGBIHBOPIF() uint32 {
	if x != nil {
		return x.MBGBIHBOPIF
	}
	return 0
}

func (x *GCGSkillPreviewOnstageChangeInfo) GetIJBIHEKEEHD() uint32 {
	if x != nil {
		return x.IJBIHEKEEHD
	}
	return 0
}
...
var file_GCGSkillPreviewOnstageChangeInfo_proto_rawDesc = []byte{
	...
	0x4d, 0x42, 0x47, 0x42, 0x49, 0x48, 0x42, 0x4f, 0x50, 0x49, 0x46, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0d, 0x52, 0x0b, 0x4d, 0x42, 0x47, 0x42, 0x49, 0x48, 0x42, 0x4f, 0x50, 0x49, 0x46, 0x12, 0x20,
	0x0a, 0x0b, 0x49, 0x4a, 0x42, 0x49, 0x48, 0x45, 0x4b, 0x45, 0x45, 0x48, 0x44, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x49, 0x4a, 0x42, 0x49, 0x48, 0x45, 0x4b, 0x45, 0x45, 0x48, 0x44,
