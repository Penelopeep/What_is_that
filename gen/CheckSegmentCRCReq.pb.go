...
type CheckSegmentCRCReq struct {
	...
	InfoList []*SegmentCRCInfo `protobuf:"bytes,8,rep,name=info_list,json=infoList,proto3" json:"info_list,omitempty"`
}
...
var file_CheckSegmentCRCReq_proto_rawDesc = []byte{
	...
	0x69, 0x73, 0x74, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x53, 0x65, 0x67, 0x6d,
