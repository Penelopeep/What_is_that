...
type SummerTimeDungeonInfo struct {
	...
	NGLCGINHGBJ uint32 `protobuf:"varint,5,opt,name=NGLCGINHGBJ,proto3" json:"NGLCGINHGBJ,omitempty"`
	DungeonId   uint32 `protobuf:"varint,8,opt,name=dungeon_id,json=dungeonId,proto3" json:"dungeon_id,omitempty"`
	IPLPGGHGEDH uint32 `protobuf:"varint,1,opt,name=IPLPGGHGEDH,proto3" json:"IPLPGGHGEDH,omitempty"`
	AIHBMHNAANC uint32 `protobuf:"varint,2,opt,name=AIHBMHNAANC,proto3" json:"AIHBMHNAANC,omitempty"`
	HFPIEECODCM uint32 `protobuf:"varint,6,opt,name=HFPIEECODCM,proto3" json:"HFPIEECODCM,omitempty"`
}
...
func (x *SummerTimeDungeonInfo) GetNGLCGINHGBJ() uint32 {
	if x != nil {
		return x.NGLCGINHGBJ
	}
	return 0
}
...
func (x *SummerTimeDungeonInfo) GetIPLPGGHGEDH() uint32 {
	if x != nil {
		return x.IPLPGGHGEDH
	}
	return 0
}

func (x *SummerTimeDungeonInfo) GetAIHBMHNAANC() uint32 {
	if x != nil {
		return x.AIHBMHNAANC
	}
	return 0
}

func (x *SummerTimeDungeonInfo) GetHFPIEECODCM() uint32 {
	if x != nil {
		return x.HFPIEECODCM
	}
	return 0
}
...
var file_SummerTimeDungeonInfo_proto_rawDesc = []byte{
	...
	,
