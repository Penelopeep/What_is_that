...
type RequestLiveInfoRsp struct {
	...
	MJDAMPGJDCJ string `protobuf:"bytes,3,opt,name=MJDAMPGJDCJ,proto3" json:"MJDAMPGJDCJ,omitempty"`
	LiveId      uint32 `protobuf:"varint,1,opt,name=live_id,json=liveId,proto3" json:"live_id,omitempty"`
	DBFCODLGJJB string `protobuf:"bytes,10,opt,name=DBFCODLGJJB,proto3" json:"DBFCODLGJJB,omitempty"`
}
...
func (x *RequestLiveInfoRsp) GetMJDAMPGJDCJ() string {
	if x != nil {
		return x.MJDAMPGJDCJ
	}
	return ""
}
...
func (x *RequestLiveInfoRsp) GetDBFCODLGJJB() string {
	if x != nil {
		return x.DBFCODLGJJB
	}
	return ""
}
...
var file_RequestLiveInfoRsp_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x07, 0x72, 0x65, 0x74, 0x63, 0x6f, 0x64, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x4d,
	0x4a, 0x44, 0x41, 0x4d, 0x50, 0x47, 0x4a, 0x44, 0x43, 0x4a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x4d, 0x4a, 0x44, 0x41, 0x4d, 0x50, 0x47, 0x4a, 0x44, 0x43, 0x4a, 0x12, 0x17, 0x0a,
	0x07, 0x6c, 0x69, 0x76, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06,
	0x6c, 0x69, 0x76, 0x65, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x44, 0x42, 0x46, 0x43, 0x4f, 0x44,
	0x4c, 0x47, 0x4a, 0x4a, 0x42, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x44, 0x42, 0x46,
	0x43, 0x4f, 0x44, 0x4c, 0x47, 0x4a, 0x4a, 0x42, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f,
