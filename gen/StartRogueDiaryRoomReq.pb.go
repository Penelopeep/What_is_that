...
type StartRogueDiaryRoomReq struct {
	...
	RoomDifficulty uint32 `protobuf:"varint,12,opt,name=room_difficulty,json=roomDifficulty,proto3" json:"room_difficulty,omitempty"`
}
...
var file_StartRogueDiaryRoomReq_proto_rawDesc = []byte{
	...
	0x79, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x72, 0x6f, 0x6f, 0x6d, 0x44, 0x69, 0x66,
