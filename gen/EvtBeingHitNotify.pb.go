...
type EvtBeingHitNotify struct {
	...
	BeingHitInfo *EvtBeingHitInfo `protobuf:"bytes,14,opt,name=being_hit_info,json=beingHitInfo,proto3" json:"being_hit_info,omitempty"`
...
var file_EvtBeingHitNotify_proto_rawDesc = []byte{
	...
	0x67, 0x5f, 0x68, 0x69, 0x74, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b,
