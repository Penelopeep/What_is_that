...
type EvtGrapplingHookMove struct {
	...
	FPFCJFPALLI         bool     `protobuf:"varint,3,opt,name=FPFCJFPALLI,proto3" json:"FPFCJFPALLI,omitempty"`
	EntityId            uint32   `protobuf:"varint,4,opt,name=entity_id,json=entityId,proto3" json:"entity_id,omitempty"`
	OverrideCollider    string   `protobuf:"bytes,11,opt,name=override_collider,json=overrideCollider,proto3" json:"override_collider,omitempty"`
	Speed               float32  `protobuf:"fixed32,5,opt,name=speed,proto3" json:"speed,omitempty"`
	PMHJPLEMFAD         bool     `protobuf:"varint,12,opt,name=PMHJPLEMFAD,proto3" json:"PMHJPLEMFAD,omitempty"`
	AnimatorStateIdList []uint32 `protobuf:"varint,1,rep,packed,name=animator_state_id_list,json=animatorStateIdList,proto3" json:"animator_state_id_list,omitempty"`
	CGJPAHPGHHK         float32  `protobuf:"fixed32,10,opt,name=CGJPAHPGHHK,proto3" json:"CGJPAHPGHHK,omitempty"`
	TargetPos           *Vector  `protobuf:"bytes,7,opt,name=target_pos,json=targetPos,proto3" json:"target_pos,omitempty"`
	FNFBDGDNJCC         float32  `protobuf:"fixed32,13,opt,name=FNFBDGDNJCC,proto3" json:"FNFBDGDNJCC,omitempty"`
}
...
func (x *EvtGrapplingHookMove) GetFPFCJFPALLI() bool {
	if x != nil {
		return x.FPFCJFPALLI
	}
	return false
}
...
func (x *EvtGrapplingHookMove) GetPMHJPLEMFAD() bool {
	if x != nil {
		return x.PMHJPLEMFAD
	}
	return false
}
...
func (x *EvtGrapplingHookMove) GetCGJPAHPGHHK() float32 {
	if x != nil {
		return x.CGJPAHPGHHK
	}
	return 0
}
...
func (x *EvtGrapplingHookMove) GetFNFBDGDNJCC() float32 {
	if x != nil {
		return x.FNFBDGDNJCC
	}
	return 0
}
...
var file_EvtGrapplingHookMove_proto_rawDesc = []byte{
	...
	,
