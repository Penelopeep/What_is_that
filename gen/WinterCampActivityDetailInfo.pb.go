...
type WinterCampActivityDetailInfo struct {
	...
	FANCDPPOIGF     []uint32                   `protobuf:"varint,10,rep,packed,name=FANCDPPOIGF,proto3" json:"FANCDPPOIGF,omitempty"`
	BattleInfo      *WinterCampStageInfo       `protobuf:"bytes,13,opt,name=battle_info,json=battleInfo,proto3" json:"battle_info,omitempty"`
	FDDPLJAJCJF     []uint32                   `protobuf:"varint,7,rep,packed,name=FDDPLJAJCJF,proto3" json:"FDDPLJAJCJF,omitempty"`
	...
	ExploreInfo     *WinterCampStageInfo       `protobuf:"bytes,15,opt,name=explore_info,json=exploreInfo,proto3" json:"explore_info,omitempty"`
	UsedItemList    []*ItemParam               `protobuf:"bytes,8,rep,name=used_item_list,json=usedItemList,proto3" json:"used_item_list,omitempty"`
	JPFBCGKIAJL     []uint32                   `protobuf:"varint,4,rep,packed,name=JPFBCGKIAJL,proto3" json:"JPFBCGKIAJL,omitempty"`
}
...
func (x *WinterCampActivityDetailInfo) GetFANCDPPOIGF() []uint32 {
	if x != nil {
		return x.FANCDPPOIGF
	}
	return nil
}
...
func (x *WinterCampActivityDetailInfo) GetFDDPLJAJCJF() []uint32 {
	if x != nil {
		return x.FDDPLJAJCJF
	}
	return nil
}
...
func (x *WinterCampActivityDetailInfo) GetJPFBCGKIAJL() []uint32 {
	if x != nil {
		return x.JPFBCGKIAJL
	}
	return nil
}
...
var file_WinterCampActivityDetailInfo_proto_rawDesc = []byte{
	...
	,
	...
	0x72, 0x65, 0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e,
	...
	0x73, 0x74, 0x12, 0x20, 0x0a, 0x0b, 0x4a, 0x50, 0x46, 0x42, 0x43, 0x47, 0x4b, 0x49, 0x41, 0x4a,
	0x4c, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0b, 0x4a, 0x50, 0x46, 0x42, 0x43, 0x47, 0x4b,
	0x49, 0x41, 0x4a, 0x4c, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
