...
type VintageMarketStoreOpInfo struct {
	...
	LBNGJLNFDIG  uint32   `protobuf:"varint,7,opt,name=LBNGJLNFDIG,proto3" json:"LBNGJLNFDIG,omitempty"`
	...
	AHDCCAFBDLA  uint32   `protobuf:"varint,1,opt,name=AHDCCAFBDLA,proto3" json:"AHDCCAFBDLA,omitempty"`
	AddAttrList  []uint32 `protobuf:"varint,9,rep,packed,name=add_attr_list,json=addAttrList,proto3" json:"add_attr_list,omitempty"`
}
...
func (x *VintageMarketStoreOpInfo) GetLBNGJLNFDIG() uint32 {
	if x != nil {
...
func (x *VintageMarketStoreOpInfo) GetAHDCCAFBDLA() uint32 {
	if x != nil {
		return x.AHDCCAFBDLA
	}
	return 0
}
...
var file_VintageMarketStoreOpInfo_proto_rawDesc = []byte{
	...
	0x0b, 0x4c, 0x42, 0x4e, 0x47, 0x4a, 0x4c, 0x4e, 0x46, 0x44, 0x49, 0x47, 0x18, 0x07, 0x20, 0x01,
	...
	,
