...
type DelTeamEntityNotify struct {
	...
	DelEntityIdList []uint32 `protobuf:"varint,1,rep,packed,name=del_entity_id_list,json=delEntityIdList,proto3" json:"del_entity_id_list,omitempty"`
...
var file_DelTeamEntityNotify_proto_rawDesc = []byte{
	...
	0x0d, 0x52, 0x07, 0x73, 0x63, 0x65, 0x6e, 0x65, 0x49, 0x64, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65,
