...
type TrialAvatarGrantRecord struct {
	...
	CJJJCOPJEDA uint32 `protobuf:"varint,1,opt,name=CJJJCOPJEDA,proto3" json:"CJJJCOPJEDA,omitempty"`
	NHBDGGGMKDE uint32 `protobuf:"varint,2,opt,name=NHBDGGGMKDE,proto3" json:"NHBDGGGMKDE,omitempty"`
}
...
func (x *TrialAvatarGrantRecord) GetCJJJCOPJEDA() uint32 {
	if x != nil {
		return x.CJJJCOPJEDA
	}
	return 0
}

func (x *TrialAvatarGrantRecord) GetNHBDGGGMKDE() uint32 {
	if x != nil {
		return x.NHBDGGGMKDE
	}
	return 0
}
...
var file_TrialAvatarGrantRecord_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5c,
	0x0a, 0x16, 0x54, 0x72, 0x69, 0x61, 0x6c, 0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x47, 0x72, 0x61,
	0x6e, 0x74, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x4a, 0x4a, 0x4a,
	0x43, 0x4f, 0x50, 0x4a, 0x45, 0x44, 0x41, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x43,
	0x4a, 0x4a, 0x4a, 0x43, 0x4f, 0x50, 0x4a, 0x45, 0x44, 0x41, 0x12, 0x20, 0x0a, 0x0b, 0x4e, 0x48,
	0x42, 0x44, 0x47, 0x47, 0x47, 0x4d, 0x4b, 0x44, 0x45, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0b, 0x4e, 0x48, 0x42, 0x44, 0x47, 0x47, 0x47, 0x4d, 0x4b, 0x44, 0x45, 0x42, 0x06, 0x5a, 0x04,
