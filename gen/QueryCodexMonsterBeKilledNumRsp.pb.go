...
type QueryCodexMonsterBeKilledNumRsp struct {
	...
	BeKilledNumList   []uint32 `protobuf:"varint,12,rep,packed,name=be_killed_num_list,json=beKilledNumList,proto3" json:"be_killed_num_list,omitempty"`      // EKCLLDCMJLB
	BeCapturedNumList []uint32 `protobuf:"varint,7,rep,packed,name=be_captured_num_list,json=beCapturedNumList,proto3" json:"be_captured_num_list,omitempty"` // CJFGLJIGKNL
...
var file_QueryCodexMonsterBeKilledNumRsp_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x0f, 0x62, 0x65, 0x4b, 0x69, 0x6c, 0x6c, 0x65,
	...
	0x18, 0x07, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x11, 0x62, 0x65, 0x43, 0x61, 0x70, 0x74, 0x75, 0x72,
