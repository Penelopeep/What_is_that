...
type AllMarkPointNotify struct {
	...
	MarkList []*MapMarkPoint `protobuf:"bytes,10,rep,name=mark_list,json=markList,proto3" json:"mark_list,omitempty"`
}
...
var file_AllMarkPointNotify_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x4d, 0x61, 0x70, 0x4d, 0x61, 0x72,
