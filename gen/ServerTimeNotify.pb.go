...
type ServerTimeNotify struct {
	...
	ServerTime uint64 `protobuf:"varint,10,opt,name=server_time,json=serverTime,proto3" json:"server_time,omitempty"`
}
...
var file_ServerTimeNotify_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28,
