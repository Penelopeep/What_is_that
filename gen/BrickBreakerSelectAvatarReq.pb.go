...
type BrickBreakerSelectAvatarReq struct {
	...
	AvatarId []uint32 `protobuf:"varint,1,rep,packed,name=avatar_id,json=avatarId,proto3" json:"avatar_id,omitempty"`
}
...
var file_BrickBreakerSelectAvatarReq_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x03, 0x28, 0x0d, 0x52, 0x08, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x49, 0x64, 0x42,
