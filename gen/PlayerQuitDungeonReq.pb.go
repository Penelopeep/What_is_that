...
type PlayerQuitDungeonReq struct {
	...
	IsQuitImmediately bool   `protobuf:"varint,5,opt,name=is_quit_immediately,json=isQuitImmediately,proto3" json:"is_quit_immediately,omitempty"`
}
...
var file_PlayerQuitDungeonReq_proto_rawDesc = []byte{
	...
	0x69, 0x61, 0x74, 0x65, 0x6c, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x69, 0x73,
