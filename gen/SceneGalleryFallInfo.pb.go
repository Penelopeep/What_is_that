...
type SceneGalleryFallInfo struct {
	...
	ScenePlayerFallInfoMap map[uint32]*FallPlayerInfo `protobuf:"bytes,10,rep,name=scene_player_fall_info_map,json=scenePlayerFallInfoMap,proto3" json:"scene_player_fall_info_map,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
var file_SceneGalleryFallInfo_proto_rawDesc = []byte{
	...
	0x5f, 0x69, 0x6e, 0x66, 0x6f, 0x5f, 0x6d, 0x61, 0x70, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32,
