...
type AvatarEquipAffixInfo struct {
	...
	HADFPPBMPBC uint32 `protobuf:"varint,1,opt,name=HADFPPBMPBC,proto3" json:"HADFPPBMPBC,omitempty"`
	HLEKEGIICBH uint32 `protobuf:"varint,2,opt,name=HLEKEGIICBH,proto3" json:"HLEKEGIICBH,omitempty"`
}
...
func (x *AvatarEquipAffixInfo) GetHADFPPBMPBC() uint32 {
	if x != nil {
		return x.HADFPPBMPBC
	}
	return 0
}

func (x *AvatarEquipAffixInfo) GetHLEKEGIICBH() uint32 {
	if x != nil {
		return x.HLEKEGIICBH
	}
	return 0
}
...
var file_AvatarEquipAffixInfo_proto_rawDesc = []byte{
	...
	0x69, 0x78, 0x49, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5a, 0x0a, 0x14,
	0x41, 0x76, 0x61, 0x74, 0x61, 0x72, 0x45, 0x71, 0x75, 0x69, 0x70, 0x41, 0x66, 0x66, 0x69, 0x78,
	0x49, 0x6e, 0x66, 0x6f, 0x12, 0x20, 0x0a, 0x0b, 0x48, 0x41, 0x44, 0x46, 0x50, 0x50, 0x42, 0x4d,
	0x50, 0x42, 0x43, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x48, 0x41, 0x44, 0x46, 0x50,
	0x50, 0x42, 0x4d, 0x50, 0x42, 0x43, 0x12, 0x20, 0x0a, 0x0b, 0x48, 0x4c, 0x45, 0x4b, 0x45, 0x47,
	0x49, 0x49, 0x43, 0x42, 0x48, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x48, 0x4c, 0x45,
	0x4b, 0x45, 0x47, 0x49, 0x49, 0x43, 0x42, 0x48, 0x42, 0x06, 0x5a, 0x04, 0x67, 0x65, 0x6e, 0x2f,
